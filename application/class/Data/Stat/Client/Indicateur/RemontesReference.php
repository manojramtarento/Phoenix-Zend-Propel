...
/**
 * Description of RemontesReference
 *
 * @author info20
 */
class Data_Stat_Client_Indicateur_RemontesReference extends Data_Stat_Client_Indicateur_Abstract
{
    ...
    {
        return Phoenix_Translation_Files::getPdf($this->getStatClientInstance()->getOperation()->getOpDevisLang(), 'stats', 'header_remonte_reference');
    }
    ...
    public function addToExcel(\PHPExcel &$oPHPExcel)
    {
        ...
        $sheet->setCellValueByColumnAndRow(0, 1, 'référence');

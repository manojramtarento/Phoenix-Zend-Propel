...
/**
 * Description of RemontesEnseigne
 *
 * @author info20
 */
class Data_Stat_Client_Indicateur_RemontesEnseigne extends Data_Stat_Client_Indicateur_Abstract
{
    ...
    {
        return Phoenix_Translation_Files::getPdf($this->getStatClientInstance()->getOperation()->getOpDevisLang(), 'stats', 'header_remonte_enseigne');
    }
    ...
    public function addToExcel(\PHPExcel &$oPHPExcel)
    {
        ...
        $sheet->setCellValueByColumnAndRow(0, 1, 'enseigne');

...
return array(
    1 => array(
        ...
        'query' => 'SELECT
                                ...
                                FROM
                                    (SELECT
                                            GROUP_CONCAT(ropop.r_op_option_libelle
                                                SEPARATOR \' - \') AS g_options,
                                            op.op_id
                                    FROM
                                        operations op
                                    ...
                                    LEFT JOIN r_operation_options ropop_parent ON ropop_parent.r_op_option_id = ropop.r_op_option_parent AND ropop_parent.actif = 1
                                    LEFT JOIN r_operation_options ropop_parent_2 ON ropop_parent_2.r_op_option_id = ropop_parent.r_op_option_parent AND ropop_parent_2.actif = 1

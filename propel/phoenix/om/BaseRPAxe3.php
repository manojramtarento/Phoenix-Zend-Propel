...
/**
 * Base class that represents a row from the 'r_p_axe3' table.
 *
 *
 *
 * @package    propel.generator.phoenix.om
 */
abstract class BaseRPAxe3 extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'RPAxe3Peer';
    ...
    /**
     * The value for the r_p_axe3_id field.
     * @var        int
     */
    protected $r_p_axe3_id;

    /**
     * The value for the r_p_axe3_tag field.
     * @var        string
     */
    protected $r_p_axe3_tag;

    /**
     * The value for the r_p_axe3_libelle field.
     * @var        string
     */
    protected $r_p_axe3_libelle;

    /**
     * The value for the r_p_axe3_actif field.
     * @var        boolean
     */
    protected $r_p_axe3_actif;
    ...
    /**
     * Get the [r_p_axe3_id] column value.
     *
     * @return int
     */
    public function getRPAxe3Id()
    {

        return $this->r_p_axe3_id;
    }

    /**
     * Get the [r_p_axe3_tag] column value.
     *
     * @return string
     */
    public function getRPAxe3Tag()
    {

        return $this->r_p_axe3_tag;
    }

    /**
     * Get the [r_p_axe3_libelle] column value.
     *
     * @return string
     */
    public function getRPAxe3Libelle()
    {

        return $this->r_p_axe3_libelle;
    }

    /**
     * Get the [r_p_axe3_actif] column value.
     *
     * @return boolean
     */
    public function getRPAxe3Actif()
    {

        return $this->r_p_axe3_actif;
    }

    /**
     * Set the value of [r_p_axe3_id] column.
     *
     * @param  int $v new value
     * @return RPAxe3 The current object (for fluent API support)
     */
    public function setRPAxe3Id($v)
    {
                if ($v === ''){
                    $v = null;
                }
                ...
                if ($this->r_p_axe3_id !== $v) {
                    $this->r_p_axe3_id = $v;
                    $this->modifiedColumns[] = RPAxe3Peer::R_P_AXE3_ID;
                }
    ...
    /**
     * Set the value of [r_p_axe3_tag] column.
     *
     * @param  string $v new value
     * @return RPAxe3 The current object (for fluent API support)
     */
    public function setRPAxe3Tag($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->r_p_axe3_tag !== $v) {
            $this->r_p_axe3_tag = $v;
            $this->modifiedColumns[] = RPAxe3Peer::R_P_AXE3_TAG;
        }
    ...
    /**
     * Set the value of [r_p_axe3_libelle] column.
     *
     * @param  string $v new value
     * @return RPAxe3 The current object (for fluent API support)
     */
    public function setRPAxe3Libelle($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->r_p_axe3_libelle !== $v) {
            $this->r_p_axe3_libelle = $v;
            $this->modifiedColumns[] = RPAxe3Peer::R_P_AXE3_LIBELLE;
        }
    ...
    /**
     * Sets the value of the [r_p_axe3_actif] column.
     ...
     * @return RPAxe3 The current object (for fluent API support)
     */
    public function setRPAxe3Actif($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
        ...
        if ($this->r_p_axe3_actif !== $v) {
            $this->r_p_axe3_actif = $v;
            $this->modifiedColumns[] = RPAxe3Peer::R_P_AXE3_ACTIF;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->r_p_axe3_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->r_p_axe3_tag = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->r_p_axe3_libelle = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->r_p_axe3_actif = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = RPAxe3Peer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating RPAxe3 object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RPAxe3Peer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RPAxe3Query::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RPAxe3Peer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RPAxe3Peer::R_P_AXE3_ID)) {
            $modifiedColumns[':p' . $index++]  = '`r_p_axe3_id`';
        }
        if ($this->isColumnModified(RPAxe3Peer::R_P_AXE3_TAG)) {
            $modifiedColumns[':p' . $index++]  = '`r_p_axe3_tag`';
        }
        if ($this->isColumnModified(RPAxe3Peer::R_P_AXE3_LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`r_p_axe3_libelle`';
        }
        if ($this->isColumnModified(RPAxe3Peer::R_P_AXE3_ACTIF)) {
            $modifiedColumns[':p' . $index++]  = '`r_p_axe3_actif`';
        }

        $sql = sprintf(
            'INSERT INTO `r_p_axe3` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`r_p_axe3_id`':
                        $stmt->bindValue($identifier, $this->r_p_axe3_id, PDO::PARAM_INT);
                        break;
                    case '`r_p_axe3_tag`':
                        $stmt->bindValue($identifier, $this->r_p_axe3_tag, PDO::PARAM_STR);
                        break;
                    case '`r_p_axe3_libelle`':
                        $stmt->bindValue($identifier, $this->r_p_axe3_libelle, PDO::PARAM_STR);
                        break;
                    case '`r_p_axe3_actif`':
                        $stmt->bindValue($identifier, (int) $this->r_p_axe3_actif, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    */
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RPAxe3Peer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RPAxe3Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getRPAxe3Id();
                break;
            case 1:
                return $this->getRPAxe3Tag();
                break;
            case 2:
                return $this->getRPAxe3Libelle();
                break;
            case 3:
                return $this->getRPAxe3Actif();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['RPAxe3'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RPAxe3'][$this->getPrimaryKey()] = true;
        $keys = RPAxe3Peer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getRPAxe3Id(),
            $keys[1] => $this->getRPAxe3Tag(),
            $keys[2] => $this->getRPAxe3Libelle(),
            $keys[3] => $this->getRPAxe3Actif(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setRPAxe3Id($value);
                break;
            case 1:
                $this->setRPAxe3Tag($value);
                break;
            case 2:
                $this->setRPAxe3Libelle($value);
                break;
            case 3:
                $this->setRPAxe3Actif($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setRPAxe3Id($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setRPAxe3Tag($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setRPAxe3Libelle($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setRPAxe3Actif($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RPAxe3Peer::R_P_AXE3_ID)) $criteria->add(RPAxe3Peer::R_P_AXE3_ID, $this->r_p_axe3_id);
        if ($this->isColumnModified(RPAxe3Peer::R_P_AXE3_TAG)) $criteria->add(RPAxe3Peer::R_P_AXE3_TAG, $this->r_p_axe3_tag);
        if ($this->isColumnModified(RPAxe3Peer::R_P_AXE3_LIBELLE)) $criteria->add(RPAxe3Peer::R_P_AXE3_LIBELLE, $this->r_p_axe3_libelle);
        if ($this->isColumnModified(RPAxe3Peer::R_P_AXE3_ACTIF)) $criteria->add(RPAxe3Peer::R_P_AXE3_ACTIF, $this->r_p_axe3_actif);
    ...
    {
        $criteria = new Criteria(RPAxe3Peer::DATABASE_NAME);
        $criteria->add(RPAxe3Peer::R_P_AXE3_ID, $this->r_p_axe3_id);
    ...
    /**
     * Generic method to set the primary key (r_p_axe3_id column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of RPAxe3 (or compatible) type.
    ...
    {
        $copyObj->setRPAxe3Tag($this->getRPAxe3Tag());
        $copyObj->setRPAxe3Libelle($this->getRPAxe3Libelle());
        $copyObj->setRPAxe3Actif($this->getRPAxe3Actif());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setRPAxe3Id(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return RPAxe3 Clone of current object.
     * @throws PropelException
     */
     ...
     * If this RPAxe3 is new, it will return
    ...
    public function setRPrestationss(PropelCollection $rPrestationss, PropelPDO $con = null)
    {
        ...
        foreach ($rPrestationssToDelete as $rPrestationsRemoved) {
            $rPrestationsRemoved->setAxe3(null);
        }
     ...
     * Otherwise if this RPAxe3 is new, it will return
     * an empty collection; or if this RPAxe3 has previously
     * been saved, it will retrieve related RPrestationss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in RPAxe3.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        $this->r_p_axe3_id = null;
        $this->r_p_axe3_tag = null;
        $this->r_p_axe3_libelle = null;
        $this->r_p_axe3_actif = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(RPAxe3Peer::DEFAULT_STRING_FORMAT);
    }
    ...
    // utils behavior
            ...
            */
            public function getConnection(){
                return BaseRPAxe3Peer::getConnection();
            }
}

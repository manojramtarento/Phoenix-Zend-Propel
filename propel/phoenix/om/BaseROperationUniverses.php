...
/**
 * Base class that represents a row from the 'r_operation_universes' table.
 *
 *
 *
 * @package    propel.generator.phoenix.om
 */
abstract class BaseROperationUniverses extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ROperationUniversesPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ROperationUniversesPeer
     */
    ...
    /**
     * The value for the r_operation_universe_id field.
     * @var        int
     */
    protected $r_operation_universe_id;

    /**
     * The value for the r_operation_universe_label field.
     * @var        string
     */
    protected $r_operation_universe_label;

    /**
     * The value for the r_operation_universe_actif field.
     * Note: this column has a database default value of: 1
     * @var        int
     */
    protected $r_operation_universe_actif;

    /**
     * The value for the r_operation_universe_order field.
     * @var        int
     */
    protected $r_operation_universe_order;
    ...
    {
        $this->r_operation_universe_actif = 1;
    }

    /**
     * Initializes internal state of BaseROperationUniverses object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [r_operation_universe_id] column value.
     *
     * @return int
     */
    public function getROperationUniverseId()
    {

        return $this->r_operation_universe_id;
    }

    /**
     * Get the [r_operation_universe_label] column value.
     *
     * @return string
     */
    public function getROperationUniverseLabel()
    {

        return $this->r_operation_universe_label;
    }

    /**
     * Get the [r_operation_universe_actif] column value.
     *
     * @return int
     */
    public function getROperationUniverseActif()
    {

        return $this->r_operation_universe_actif;
    }

    /**
     * Get the [r_operation_universe_order] column value.
     *
     * @return int
     */
    public function getROperationUniverseOrder()
    {

        return $this->r_operation_universe_order;
    }

    /**
     * Set the value of [r_operation_universe_id] column.
     *
     * @param  int $v new value
     * @return ROperationUniverses The current object (for fluent API support)
     */
    public function setROperationUniverseId($v)
    {
                if ($v === ''){
                    $v = null;
                }
                ...
                if ($this->r_operation_universe_id !== $v) {
                    $this->r_operation_universe_id = $v;
                    $this->modifiedColumns[] = ROperationUniversesPeer::R_OPERATION_UNIVERSE_ID;
                }


        return $this;
    } // setROperationUniverseId()

    /**
     * Set the value of [r_operation_universe_label] column.
     *
     * @param  string $v new value
     * @return ROperationUniverses The current object (for fluent API support)
     */
    public function setROperationUniverseLabel($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->r_operation_universe_label !== $v) {
            $this->r_operation_universe_label = $v;
            $this->modifiedColumns[] = ROperationUniversesPeer::R_OPERATION_UNIVERSE_LABEL;
        }


        return $this;
    } // setROperationUniverseLabel()

    /**
     * Set the value of [r_operation_universe_actif] column.
     *
     * @param  int $v new value
     * @return ROperationUniverses The current object (for fluent API support)
     */
    public function setROperationUniverseActif($v)
    {
                if ($v === ''){
                    $v = null;
                }
                ...
                if ($this->r_operation_universe_actif !== $v) {
                    $this->r_operation_universe_actif = $v;
                    $this->modifiedColumns[] = ROperationUniversesPeer::R_OPERATION_UNIVERSE_ACTIF;
                }


        return $this;
    } // setROperationUniverseActif()

    /**
     * Set the value of [r_operation_universe_order] column.
     *
     * @param  int $v new value
     * @return ROperationUniverses The current object (for fluent API support)
     */
    public function setROperationUniverseOrder($v)
    {
                if ($v === ''){
                    $v = null;
                }
                ...
                if ($this->r_operation_universe_order !== $v) {
                    $this->r_operation_universe_order = $v;
                    $this->modifiedColumns[] = ROperationUniversesPeer::R_OPERATION_UNIVERSE_ORDER;
                }


        return $this;
    } // setROperationUniverseOrder()
    ...
    {
            if ($this->r_operation_universe_actif !== 1) {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->r_operation_universe_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->r_operation_universe_label = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->r_operation_universe_actif = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->r_operation_universe_order = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = ROperationUniversesPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ROperationUniverses object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ROperationUniversesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ROperationUniversesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ROperationUniversesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ROperationUniversesPeer::R_OPERATION_UNIVERSE_ID;
        if (null !== $this->r_operation_universe_id) {
        ...
        if ($this->isColumnModified(ROperationUniversesPeer::R_OPERATION_UNIVERSE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`r_operation_universe_id`';
        }
        if ($this->isColumnModified(ROperationUniversesPeer::R_OPERATION_UNIVERSE_LABEL)) {
            $modifiedColumns[':p' . $index++]  = '`r_operation_universe_label`';
        }
        if ($this->isColumnModified(ROperationUniversesPeer::R_OPERATION_UNIVERSE_ACTIF)) {
            $modifiedColumns[':p' . $index++]  = '`r_operation_universe_actif`';
        }
        if ($this->isColumnModified(ROperationUniversesPeer::R_OPERATION_UNIVERSE_ORDER)) {
            $modifiedColumns[':p' . $index++]  = '`r_operation_universe_order`';
        }

        $sql = sprintf(
            'INSERT INTO `r_operation_universes` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`r_operation_universe_id`':
                        $stmt->bindValue($identifier, $this->r_operation_universe_id, PDO::PARAM_INT);
                        break;
                    case '`r_operation_universe_label`':
                        $stmt->bindValue($identifier, $this->r_operation_universe_label, PDO::PARAM_STR);
                        break;
                    case '`r_operation_universe_actif`':
                        $stmt->bindValue($identifier, $this->r_operation_universe_actif, PDO::PARAM_INT);
                        break;
                    case '`r_operation_universe_order`':
                        $stmt->bindValue($identifier, $this->r_operation_universe_order, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
        ...
        $this->setROperationUniverseId($pk);
    ...
    */
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ROperationUniversesPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ROperationUniversesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getROperationUniverseId();
                break;
            case 1:
                return $this->getROperationUniverseLabel();
                break;
            case 2:
                return $this->getROperationUniverseActif();
                break;
            case 3:
                return $this->getROperationUniverseOrder();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['ROperationUniverses'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ROperationUniverses'][$this->getPrimaryKey()] = true;
        $keys = ROperationUniversesPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getROperationUniverseId(),
            $keys[1] => $this->getROperationUniverseLabel(),
            $keys[2] => $this->getROperationUniverseActif(),
            $keys[3] => $this->getROperationUniverseOrder(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setROperationUniverseId($value);
                break;
            case 1:
                $this->setROperationUniverseLabel($value);
                break;
            case 2:
                $this->setROperationUniverseActif($value);
                break;
            case 3:
                $this->setROperationUniverseOrder($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setROperationUniverseId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setROperationUniverseLabel($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setROperationUniverseActif($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setROperationUniverseOrder($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ROperationUniversesPeer::R_OPERATION_UNIVERSE_ID)) $criteria->add(ROperationUniversesPeer::R_OPERATION_UNIVERSE_ID, $this->r_operation_universe_id);
        if ($this->isColumnModified(ROperationUniversesPeer::R_OPERATION_UNIVERSE_LABEL)) $criteria->add(ROperationUniversesPeer::R_OPERATION_UNIVERSE_LABEL, $this->r_operation_universe_label);
        if ($this->isColumnModified(ROperationUniversesPeer::R_OPERATION_UNIVERSE_ACTIF)) $criteria->add(ROperationUniversesPeer::R_OPERATION_UNIVERSE_ACTIF, $this->r_operation_universe_actif);
        if ($this->isColumnModified(ROperationUniversesPeer::R_OPERATION_UNIVERSE_ORDER)) $criteria->add(ROperationUniversesPeer::R_OPERATION_UNIVERSE_ORDER, $this->r_operation_universe_order);
    ...
    {
        $criteria = new Criteria(ROperationUniversesPeer::DATABASE_NAME);
        $criteria->add(ROperationUniversesPeer::R_OPERATION_UNIVERSE_ID, $this->r_operation_universe_id);
    ...
    /**
     * Generic method to set the primary key (r_operation_universe_id column).
     *
    ...
    {
        $this->setROperationUniverseId($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getROperationUniverseId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ROperationUniverses (or compatible) type.
    ...
    {
        $copyObj->setROperationUniverseLabel($this->getROperationUniverseLabel());
        $copyObj->setROperationUniverseActif($this->getROperationUniverseActif());
        $copyObj->setROperationUniverseOrder($this->getROperationUniverseOrder());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setROperationUniverseId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ROperationUniverses Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ROperationUniversesPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ROperationUniversesPeer();
        }
     ...
     * If this ROperationUniverses is new, it will return
        ...
        if (null === $this->collOperationss || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collOperationss) {
                ...
                $collOperationss = OperationsQuery::create(null, $criteria)
                    ->filterByOperationUniverse($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setOperationss(PropelCollection $operationss, PropelPDO $con = null)
    {
        ...
        foreach ($operationssToDelete as $operationsRemoved) {
            $operationsRemoved->setOperationUniverse(null);
        }
    ...
    protected function doAddOperations($operations)
    {
        ...
        $operations->setOperationUniverse($this);
    }
    ...
    public function removeOperations($operations)
    {
        if ($this->getOperationss()->contains($operations)) {
            ...
            $operations->setOperationUniverse(null);
        }
     ...
     * Otherwise if this ROperationUniverses is new, it will return
     * an empty collection; or if this ROperationUniverses has previously
     * been saved, it will retrieve related Operationss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ROperationUniverses.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function setLnkROperationTypeSubTemplateMediasUniversess(PropelCollection $lnkROperationTypeSubTemplateMediasUniversess, PropelPDO $con = null)
    {
        ...
        foreach ($lnkROperationTypeSubTemplateMediasUniversessToDelete as $lnkROperationTypeSubTemplateMediasUniversesRemoved) {
            $lnkROperationTypeSubTemplateMediasUniversesRemoved->setOperationUniverse(null);
        }
    ...
    protected function doAddLnkROperationTypeSubTemplateMediasUniverses($lnkROperationTypeSubTemplateMediasUniverses)
    {
        ...
        $lnkROperationTypeSubTemplateMediasUniverses->setOperationUniverse($this);
    }
    ...
    public function removeLnkROperationTypeSubTemplateMediasUniverses($lnkROperationTypeSubTemplateMediasUniverses)
    {
        if ($this->getLnkROperationTypeSubTemplateMediasUniversess()->contains($lnkROperationTypeSubTemplateMediasUniverses)) {
            ...
            $lnkROperationTypeSubTemplateMediasUniverses->setOperationUniverse(null);
        }
    ...
    {
        $this->r_operation_universe_id = null;
        $this->r_operation_universe_label = null;
        $this->r_operation_universe_actif = null;
        $this->r_operation_universe_order = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(ROperationUniversesPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    // utils behavior
            ...
            */
            public function getConnection(){
                return BaseROperationUniversesPeer::getConnection();
            }
}

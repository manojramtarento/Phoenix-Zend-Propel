...
/**
 * Base class that represents a row from the 'facture_statuts' table.
 *
 *
 *
 * @package    propel.generator.phoenix.om
 */
abstract class BaseFactureStatuts extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'FactureStatutsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        FactureStatutsPeer
     */
    ...
    /**
     * The value for the is_effective field.
    ...
    /**
     * Initializes internal state of BaseFactureStatuts object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [is_effective] column value.
     *
     * @return boolean
     */
    ...
    /**
     * Set the value of [fs_id] column.
     *
     * @param  int $v new value
     * @return FactureStatuts The current object (for fluent API support)
     */
    public function setFsId($v)
    {
                if ($v === ''){
                    $v = null;
                }
                ...
                if ($this->fs_id !== $v) {
                    $this->fs_id = $v;
                    $this->modifiedColumns[] = FactureStatutsPeer::FS_ID;
                }
    ...
    public function setFactId($v)
    {
                ...
                if ($this->fact_id !== $v) {
                    $this->fact_id = $v;
                    $this->modifiedColumns[] = FactureStatutsPeer::FACT_ID;
                }
    ...
    public function setRFactStatId($v)
    {
                ...
                if ($this->r_fact_stat_id !== $v) {
                    ...
                    $this->modifiedColumns[] = FactureStatutsPeer::R_FACT_STAT_ID;
                }
    ...
    public function setUserId($v)
    {
                ...
                if ($this->user_id !== $v) {
                    $this->user_id = $v;
                    $this->modifiedColumns[] = FactureStatutsPeer::USER_ID;
                }
    ...
    public function setUserModify($v)
    {
                ...
                if ($this->user_modify !== $v) {
                    $this->user_modify = $v;
                    $this->modifiedColumns[] = FactureStatutsPeer::USER_MODIFY;
                }
    ...
    public function setDateCreate($v)
    {
        ...
        if ($this->date_create !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = FactureStatutsPeer::DATE_CREATE;
            }
    ...
    public function setDateModify($v)
    {
        ...
        if ($this->date_modify !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = FactureStatutsPeer::DATE_MODIFY;
            }
        } // if either are not null
    ...
    /**
     * Sets the value of the [is_effective] column.
    ...
    public function setIsEffective($v)
    {
        ...
        if ($this->is_effective !== $v) {
            $this->is_effective = $v;
            $this->modifiedColumns[] = FactureStatutsPeer::IS_EFFECTIVE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->fs_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->fact_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->r_fact_stat_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            ...
            $this->is_effective = ($row[$startcol + 7] !== null) ? (boolean) $row[$startcol + 7] : null;
            $this->resetModified();
            ...
            return $startcol + 8; // 8 = FactureStatutsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating FactureStatuts object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FactureStatutsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = FactureStatutsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FactureStatutsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FactureStatutsPeer::FS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`fs_id`';
        }
        if ($this->isColumnModified(FactureStatutsPeer::FACT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`fact_id`';
        }
        if ($this->isColumnModified(FactureStatutsPeer::R_FACT_STAT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`r_fact_stat_id`';
        }
        if ($this->isColumnModified(FactureStatutsPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(FactureStatutsPeer::USER_MODIFY)) {
            $modifiedColumns[':p' . $index++]  = '`user_modify`';
        }
        if ($this->isColumnModified(FactureStatutsPeer::DATE_CREATE)) {
            $modifiedColumns[':p' . $index++]  = '`date_create`';
        }
        if ($this->isColumnModified(FactureStatutsPeer::DATE_MODIFY)) {
            $modifiedColumns[':p' . $index++]  = '`date_modify`';
        }
        if ($this->isColumnModified(FactureStatutsPeer::IS_EFFECTIVE)) {
            $modifiedColumns[':p' . $index++]  = '`is_effective`';
        }

        $sql = sprintf(
            'INSERT INTO `facture_statuts` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`fs_id`':
                        $stmt->bindValue($identifier, $this->fs_id, PDO::PARAM_INT);
                        break;
                    case '`fact_id`':
                    ...
                    case '`date_modify`':
                        ...
                        break;
                    case '`is_effective`':
                        $stmt->bindValue($identifier, (int) $this->is_effective, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    */
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = FactureStatutsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = FactureStatutsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['FactureStatuts'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['FactureStatuts'][$this->getPrimaryKey()] = true;
        $keys = FactureStatutsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getFsId(),
            $keys[1] => $this->getFactId(),
            $keys[2] => $this->getRFactStatId(),
            $keys[3] => $this->getUserId(),
            $keys[4] => $this->getUserModify(),
            $keys[5] => $this->getDateCreate(),
            $keys[6] => $this->getDateModify(),
            $keys[7] => $this->getIsEffective(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setFsId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setFactId($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setRFactStatId($arr[$keys[2]]);
        ...
        if (array_key_exists($keys[7], $arr)) $this->setIsEffective($arr[$keys[7]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FactureStatutsPeer::FS_ID)) $criteria->add(FactureStatutsPeer::FS_ID, $this->fs_id);
        if ($this->isColumnModified(FactureStatutsPeer::FACT_ID)) $criteria->add(FactureStatutsPeer::FACT_ID, $this->fact_id);
        if ($this->isColumnModified(FactureStatutsPeer::R_FACT_STAT_ID)) $criteria->add(FactureStatutsPeer::R_FACT_STAT_ID, $this->r_fact_stat_id);
        if ($this->isColumnModified(FactureStatutsPeer::USER_ID)) $criteria->add(FactureStatutsPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(FactureStatutsPeer::USER_MODIFY)) $criteria->add(FactureStatutsPeer::USER_MODIFY, $this->user_modify);
        if ($this->isColumnModified(FactureStatutsPeer::DATE_CREATE)) $criteria->add(FactureStatutsPeer::DATE_CREATE, $this->date_create);
        if ($this->isColumnModified(FactureStatutsPeer::DATE_MODIFY)) $criteria->add(FactureStatutsPeer::DATE_MODIFY, $this->date_modify);
        if ($this->isColumnModified(FactureStatutsPeer::IS_EFFECTIVE)) $criteria->add(FactureStatutsPeer::IS_EFFECTIVE, $this->is_effective);
    ...
    {
        $criteria = new Criteria(FactureStatutsPeer::DATABASE_NAME);
        $criteria->add(FactureStatutsPeer::FS_ID, $this->fs_id);
    ...
    /**
     * Generic method to set the primary key (fs_id column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of FactureStatuts (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setRFactStatId($this->getRFactStatId());
        ...
        $copyObj->setIsEffective($this->getIsEffective());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setFsId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return FactureStatuts Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return FactureStatutsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new FactureStatutsPeer();
        }
    ...
    public function getFactures(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aFactures === null && ($this->fact_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aFactures->addFactureStatutss($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(FactureStatutsPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    // utils behavior
            ...
            */
            public function getConnection(){
                return BaseFactureStatutsPeer::getConnection();
            }
}

...
abstract class BaseSettingsPeer
{
    ...
    /** the column name for the setting_organisation_id field */
    const SETTING_ORGANISATION_ID = 'settings.setting_organisation_id';

    /** the column name for the setting_key field */
    const SETTING_KEY = 'settings.setting_key';

    /** the column name for the setting_value field */
    const SETTING_VALUE = 'settings.setting_value';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('SettingId', 'SettingOrganisationId', 'SettingKey', 'SettingValue', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('settingId', 'settingOrganisationId', 'settingKey', 'settingValue', ),
        BasePeer::TYPE_COLNAME => array (SettingsPeer::SETTING_ID, SettingsPeer::SETTING_ORGANISATION_ID, SettingsPeer::SETTING_KEY, SettingsPeer::SETTING_VALUE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('SETTING_ID', 'SETTING_ORGANISATION_ID', 'SETTING_KEY', 'SETTING_VALUE', ),
        BasePeer::TYPE_FIELDNAME => array ('setting_id', 'setting_organisation_id', 'setting_key', 'setting_value', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('SettingId' => 0, 'SettingOrganisationId' => 1, 'SettingKey' => 2, 'SettingValue' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('settingId' => 0, 'settingOrganisationId' => 1, 'settingKey' => 2, 'settingValue' => 3, ),
        BasePeer::TYPE_COLNAME => array (SettingsPeer::SETTING_ID => 0, SettingsPeer::SETTING_ORGANISATION_ID => 1, SettingsPeer::SETTING_KEY => 2, SettingsPeer::SETTING_VALUE => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('SETTING_ID' => 0, 'SETTING_ORGANISATION_ID' => 1, 'SETTING_KEY' => 2, 'SETTING_VALUE' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('setting_id' => 0, 'setting_organisation_id' => 1, 'setting_key' => 2, 'setting_value' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SettingsPeer::SETTING_ORGANISATION_ID);
            $criteria->addSelectColumn(SettingsPeer::SETTING_KEY);
            $criteria->addSelectColumn(SettingsPeer::SETTING_VALUE);
        } else {
            $criteria->addSelectColumn($alias . '.setting_id');
            $criteria->addSelectColumn($alias . '.setting_organisation_id');
            $criteria->addSelectColumn($alias . '.setting_key');
    ...
    public static function doCountJoinOrganisations(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(SettingsPeer::SETTING_ORGANISATION_ID, OrganisationsPeer::ORGANISATION_ID, $join_behavior);
    ...
    /**
     * Selects a collection of Settings objects pre-filled with their Organisations objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinOrganisations(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Settings) to $obj2 (Organisations)
                $obj2->addSettings($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Settings) to the collection in $obj2 (Organisations)
                $obj2->addSettings($obj1);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(SettingsPeer::SETTING_ID, (array) $values, Criteria::IN);
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($obj->isNew() || $obj->isColumnModified(SettingsPeer::SETTING_KEY))
            $columns[SettingsPeer::SETTING_KEY] = $obj->getSettingKey();

        if ($obj->isNew() || $obj->isColumnModified(SettingsPeer::SETTING_VALUE))
            $columns[SettingsPeer::SETTING_VALUE] = $obj->getSettingValue();
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(SettingsPeer::DATABASE_NAME);
        $criteria->add(SettingsPeer::SETTING_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(SettingsPeer::DATABASE_NAME);
            $criteria->add(SettingsPeer::SETTING_ID, $pks, Criteria::IN);

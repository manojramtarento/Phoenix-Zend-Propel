...
/**
 * Base class that represents a row from the 'r_delai_devis' table.
 *
 *
 *
 * @package    propel.generator.phoenix.om
 */
abstract class BaseRDelaiDevis extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'RDelaiDevisPeer';
    ...
    /**
     * The value for the r_delai_devis_id field.
     * @var        int
     */
    protected $r_delai_devis_id;

    /**
     * The value for the r_delai_devis_libelle field.
     * @var        string
     */
    protected $r_delai_devis_libelle;

    /**
     * The value for the r_delai_devis_libelle_en field.
     * @var        string
     */
    protected $r_delai_devis_libelle_en;
    ...
    /**
     * Get the [r_delai_devis_id] column value.
     *
     * @return int
     */
    public function getRDelaiDevisId()
    {

        return $this->r_delai_devis_id;
    }

    /**
     * Get the [r_delai_devis_libelle] column value.
     *
     * @return string
     */
    public function getRDelaiDevisLibelle()
    {

        return $this->r_delai_devis_libelle;
    }

    /**
     * Get the [r_delai_devis_libelle_en] column value.
     *
     * @return string
     */
    public function getRDelaiDevisLibelleEn()
    {

        return $this->r_delai_devis_libelle_en;
    }

    /**
     * Set the value of [r_delai_devis_id] column.
     *
     * @param  int $v new value
     * @return RDelaiDevis The current object (for fluent API support)
     */
    public function setRDelaiDevisId($v)
    {
                if ($v === ''){
                    $v = null;
                }
                ...
                if ($this->r_delai_devis_id !== $v) {
                    $this->r_delai_devis_id = $v;
                    $this->modifiedColumns[] = RDelaiDevisPeer::R_DELAI_DEVIS_ID;
                }
    ...
    /**
     * Set the value of [r_delai_devis_libelle] column.
     *
     * @param  string $v new value
     * @return RDelaiDevis The current object (for fluent API support)
     */
    public function setRDelaiDevisLibelle($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->r_delai_devis_libelle !== $v) {
            $this->r_delai_devis_libelle = $v;
            $this->modifiedColumns[] = RDelaiDevisPeer::R_DELAI_DEVIS_LIBELLE;
        }


        return $this;
    } // setRDelaiDevisLibelle()

    /**
     * Set the value of [r_delai_devis_libelle_en] column.
     *
     * @param  string $v new value
     * @return RDelaiDevis The current object (for fluent API support)
     */
    public function setRDelaiDevisLibelleEn($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->r_delai_devis_libelle_en !== $v) {
            $this->r_delai_devis_libelle_en = $v;
            $this->modifiedColumns[] = RDelaiDevisPeer::R_DELAI_DEVIS_LIBELLE_EN;
        }


        return $this;
    } // setRDelaiDevisLibelleEn()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->r_delai_devis_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->r_delai_devis_libelle = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->r_delai_devis_libelle_en = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = RDelaiDevisPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating RDelaiDevis object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RDelaiDevisPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RDelaiDevisQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RDelaiDevisPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RDelaiDevisPeer::R_DELAI_DEVIS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`r_delai_devis_id`';
        }
        if ($this->isColumnModified(RDelaiDevisPeer::R_DELAI_DEVIS_LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`r_delai_devis_libelle`';
        }
        if ($this->isColumnModified(RDelaiDevisPeer::R_DELAI_DEVIS_LIBELLE_EN)) {
            $modifiedColumns[':p' . $index++]  = '`r_delai_devis_libelle_en`';
        }

        $sql = sprintf(
            'INSERT INTO `r_delai_devis` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`r_delai_devis_id`':
                        $stmt->bindValue($identifier, $this->r_delai_devis_id, PDO::PARAM_INT);
                        break;
                    case '`r_delai_devis_libelle`':
                        $stmt->bindValue($identifier, $this->r_delai_devis_libelle, PDO::PARAM_STR);
                        break;
                    case '`r_delai_devis_libelle_en`':
                        $stmt->bindValue($identifier, $this->r_delai_devis_libelle_en, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    */
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RDelaiDevisPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RDelaiDevisPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getRDelaiDevisId();
                break;
            case 1:
                return $this->getRDelaiDevisLibelle();
                break;
            case 2:
                return $this->getRDelaiDevisLibelleEn();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['RDelaiDevis'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RDelaiDevis'][$this->getPrimaryKey()] = true;
        $keys = RDelaiDevisPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getRDelaiDevisId(),
            $keys[1] => $this->getRDelaiDevisLibelle(),
            $keys[2] => $this->getRDelaiDevisLibelleEn(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setRDelaiDevisId($value);
                break;
            case 1:
                $this->setRDelaiDevisLibelle($value);
                break;
            case 2:
                $this->setRDelaiDevisLibelleEn($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setRDelaiDevisId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setRDelaiDevisLibelle($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setRDelaiDevisLibelleEn($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RDelaiDevisPeer::R_DELAI_DEVIS_ID)) $criteria->add(RDelaiDevisPeer::R_DELAI_DEVIS_ID, $this->r_delai_devis_id);
        if ($this->isColumnModified(RDelaiDevisPeer::R_DELAI_DEVIS_LIBELLE)) $criteria->add(RDelaiDevisPeer::R_DELAI_DEVIS_LIBELLE, $this->r_delai_devis_libelle);
        if ($this->isColumnModified(RDelaiDevisPeer::R_DELAI_DEVIS_LIBELLE_EN)) $criteria->add(RDelaiDevisPeer::R_DELAI_DEVIS_LIBELLE_EN, $this->r_delai_devis_libelle_en);
    ...
    {
        $criteria = new Criteria(RDelaiDevisPeer::DATABASE_NAME);
        $criteria->add(RDelaiDevisPeer::R_DELAI_DEVIS_ID, $this->r_delai_devis_id);
    ...
    /**
     * Generic method to set the primary key (r_delai_devis_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getRDelaiDevisId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of RDelaiDevis (or compatible) type.
    ...
    {
        $copyObj->setRDelaiDevisLibelle($this->getRDelaiDevisLibelle());
        $copyObj->setRDelaiDevisLibelleEn($this->getRDelaiDevisLibelleEn());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setRDelaiDevisId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return RDelaiDevis Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RDelaiDevisPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RDelaiDevisPeer();
        }
     ...
     * If this RDelaiDevis is new, it will return
    ...
    public function setOperationss(PropelCollection $operationss, PropelPDO $con = null)
    {
        ...
        foreach ($operationssToDelete as $operationsRemoved) {
            $operationsRemoved->setRDelaiDevis(null);
        }
    ...
    protected function doAddOperations($operations)
    {
        ...
        $operations->setRDelaiDevis($this);
    }
    ...
    public function removeOperations($operations)
    {
        if ($this->getOperationss()->contains($operations)) {
            ...
            $operations->setRDelaiDevis(null);
        }
     ...
     * Otherwise if this RDelaiDevis is new, it will return
     * an empty collection; or if this RDelaiDevis has previously
     * been saved, it will retrieve related Operationss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in RDelaiDevis.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        $this->r_delai_devis_id = null;
        $this->r_delai_devis_libelle = null;
        $this->r_delai_devis_libelle_en = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(RDelaiDevisPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    // utils behavior
            ...
            */
            public function getConnection(){
                return BaseRDelaiDevisPeer::getConnection();
            }
}

...
/**
 * Base class that represents a row from the 'r_file_categories' table.
 *
 *
 *
 * @package    propel.generator.phoenix.om
 */
abstract class BaseRFileCategories extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'RFileCategoriesPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        RFileCategoriesPeer
     */
    ...
    /**
     * The value for the r_fca_id field.
     * @var        int
     */
    protected $r_fca_id;

    /**
     * The value for the r_fca_name field.
     * @var        string
     */
    protected $r_fca_name;
    ...
    /**
     * Get the [r_fca_id] column value.
     *
     * @return int
     */
    public function getRFcaId()
    {

        return $this->r_fca_id;
    }

    /**
     * Get the [r_fca_name] column value.
     *
     * @return string
     */
    public function getRFcaName()
    {

        return $this->r_fca_name;
    }

    /**
     * Set the value of [r_fca_id] column.
     *
     * @param  int $v new value
     * @return RFileCategories The current object (for fluent API support)
     */
    public function setRFcaId($v)
    {
                if ($v === ''){
                    $v = null;
                }
                ...
                if ($this->r_fca_id !== $v) {
                    $this->r_fca_id = $v;
                    $this->modifiedColumns[] = RFileCategoriesPeer::R_FCA_ID;
                }
    ...
    /**
     * Set the value of [r_fca_name] column.
     *
     * @param  string $v new value
     * @return RFileCategories The current object (for fluent API support)
     */
    public function setRFcaName($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->r_fca_name !== $v) {
            $this->r_fca_name = $v;
            $this->modifiedColumns[] = RFileCategoriesPeer::R_FCA_NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->r_fca_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->r_fca_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = RFileCategoriesPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating RFileCategories object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RFileCategoriesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RFileCategoriesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RFileCategoriesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->filessScheduledForDeletion !== null) {
                if (!$this->filessScheduledForDeletion->isEmpty()) {
                    foreach ($this->filessScheduledForDeletion as $files) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RFileCategoriesPeer::R_FCA_ID)) {
            $modifiedColumns[':p' . $index++]  = '`r_fca_id`';
        }
        if ($this->isColumnModified(RFileCategoriesPeer::R_FCA_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`r_fca_name`';
        }

        $sql = sprintf(
            'INSERT INTO `r_file_categories` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`r_fca_id`':
                        $stmt->bindValue($identifier, $this->r_fca_id, PDO::PARAM_INT);
                        break;
                    case '`r_fca_name`':
                        $stmt->bindValue($identifier, $this->r_fca_name, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    */
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RFileCategoriesPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RFileCategoriesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getRFcaId();
                break;
            case 1:
                return $this->getRFcaName();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['RFileCategories'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RFileCategories'][$this->getPrimaryKey()] = true;
        $keys = RFileCategoriesPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getRFcaId(),
            $keys[1] => $this->getRFcaName(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setRFcaId($value);
                break;
            case 1:
                $this->setRFcaName($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setRFcaId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setRFcaName($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RFileCategoriesPeer::R_FCA_ID)) $criteria->add(RFileCategoriesPeer::R_FCA_ID, $this->r_fca_id);
        if ($this->isColumnModified(RFileCategoriesPeer::R_FCA_NAME)) $criteria->add(RFileCategoriesPeer::R_FCA_NAME, $this->r_fca_name);
    ...
    {
        $criteria = new Criteria(RFileCategoriesPeer::DATABASE_NAME);
        $criteria->add(RFileCategoriesPeer::R_FCA_ID, $this->r_fca_id);
    ...
    /**
     * Generic method to set the primary key (r_fca_id column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of RFileCategories (or compatible) type.
    ...
    {
        $copyObj->setRFcaName($this->getRFcaName());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setRFcaId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return RFileCategories Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RFileCategoriesPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RFileCategoriesPeer();
        }
     ...
     * If this RFileCategories is new, it will return
    ...
    public function setFiless(PropelCollection $filess, PropelPDO $con = null)
    {
        ...
        foreach ($filessToDelete as $filesRemoved) {
            $filesRemoved->setRFileCategories(null);
        }
    ...
    public function removeFiles($files)
    {
        if ($this->getFiless()->contains($files)) {
            ...
            $this->filessScheduledForDeletion[]= $files;
            $files->setRFileCategories(null);
        }
    ...
    {
        return (string) $this->exportTo(RFileCategoriesPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    // utils behavior
            ...
            */
            public function getConnection(){
                return BaseRFileCategoriesPeer::getConnection();
            }
}

...
/**
 * Base class that represents a row from the 'r_p_axe4' table.
 *
 *
 *
 * @package    propel.generator.phoenix.om
 */
abstract class BaseRPAxe4 extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'RPAxe4Peer';
    ...
    /**
     * The value for the r_p_axe4_id field.
     * @var        int
     */
    protected $r_p_axe4_id;

    /**
     * The value for the r_p_axe4_tag field.
     * @var        string
     */
    protected $r_p_axe4_tag;

    /**
     * The value for the r_p_axe4_libelle field.
     * @var        string
     */
    protected $r_p_axe4_libelle;

    /**
     * The value for the r_p_axe4_actif field.
     * @var        boolean
     */
    protected $r_p_axe4_actif;
    ...
    /**
     * Get the [r_p_axe4_id] column value.
     *
     * @return int
     */
    public function getRPAxe4Id()
    {

        return $this->r_p_axe4_id;
    }

    /**
     * Get the [r_p_axe4_tag] column value.
     *
     * @return string
     */
    public function getRPAxe4Tag()
    {

        return $this->r_p_axe4_tag;
    }

    /**
     * Get the [r_p_axe4_libelle] column value.
     *
     * @return string
     */
    public function getRPAxe4Libelle()
    {

        return $this->r_p_axe4_libelle;
    }

    /**
     * Get the [r_p_axe4_actif] column value.
     *
     * @return boolean
     */
    public function getRPAxe4Actif()
    {

        return $this->r_p_axe4_actif;
    }

    /**
     * Set the value of [r_p_axe4_id] column.
     *
     * @param  int $v new value
     * @return RPAxe4 The current object (for fluent API support)
     */
    public function setRPAxe4Id($v)
    {
                if ($v === ''){
                    $v = null;
                }
                ...
                if ($this->r_p_axe4_id !== $v) {
                    $this->r_p_axe4_id = $v;
                    $this->modifiedColumns[] = RPAxe4Peer::R_P_AXE4_ID;
                }
    ...
    /**
     * Set the value of [r_p_axe4_tag] column.
     *
     * @param  string $v new value
     * @return RPAxe4 The current object (for fluent API support)
     */
    public function setRPAxe4Tag($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->r_p_axe4_tag !== $v) {
            $this->r_p_axe4_tag = $v;
            $this->modifiedColumns[] = RPAxe4Peer::R_P_AXE4_TAG;
        }
    ...
    /**
     * Set the value of [r_p_axe4_libelle] column.
     *
     * @param  string $v new value
     * @return RPAxe4 The current object (for fluent API support)
     */
    public function setRPAxe4Libelle($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->r_p_axe4_libelle !== $v) {
            $this->r_p_axe4_libelle = $v;
            $this->modifiedColumns[] = RPAxe4Peer::R_P_AXE4_LIBELLE;
        }
    ...
    /**
     * Sets the value of the [r_p_axe4_actif] column.
     ...
     * @return RPAxe4 The current object (for fluent API support)
     */
    public function setRPAxe4Actif($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
        ...
        if ($this->r_p_axe4_actif !== $v) {
            $this->r_p_axe4_actif = $v;
            $this->modifiedColumns[] = RPAxe4Peer::R_P_AXE4_ACTIF;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->r_p_axe4_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->r_p_axe4_tag = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->r_p_axe4_libelle = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->r_p_axe4_actif = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = RPAxe4Peer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating RPAxe4 object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RPAxe4Peer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RPAxe4Query::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RPAxe4Peer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RPAxe4Peer::R_P_AXE4_ID)) {
            $modifiedColumns[':p' . $index++]  = '`r_p_axe4_id`';
        }
        if ($this->isColumnModified(RPAxe4Peer::R_P_AXE4_TAG)) {
            $modifiedColumns[':p' . $index++]  = '`r_p_axe4_tag`';
        }
        if ($this->isColumnModified(RPAxe4Peer::R_P_AXE4_LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`r_p_axe4_libelle`';
        }
        if ($this->isColumnModified(RPAxe4Peer::R_P_AXE4_ACTIF)) {
            $modifiedColumns[':p' . $index++]  = '`r_p_axe4_actif`';
        }

        $sql = sprintf(
            'INSERT INTO `r_p_axe4` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`r_p_axe4_id`':
                        $stmt->bindValue($identifier, $this->r_p_axe4_id, PDO::PARAM_INT);
                        break;
                    case '`r_p_axe4_tag`':
                        $stmt->bindValue($identifier, $this->r_p_axe4_tag, PDO::PARAM_STR);
                        break;
                    case '`r_p_axe4_libelle`':
                        $stmt->bindValue($identifier, $this->r_p_axe4_libelle, PDO::PARAM_STR);
                        break;
                    case '`r_p_axe4_actif`':
                        $stmt->bindValue($identifier, (int) $this->r_p_axe4_actif, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    */
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RPAxe4Peer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RPAxe4Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getRPAxe4Id();
                break;
            case 1:
                return $this->getRPAxe4Tag();
                break;
            case 2:
                return $this->getRPAxe4Libelle();
                break;
            case 3:
                return $this->getRPAxe4Actif();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['RPAxe4'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RPAxe4'][$this->getPrimaryKey()] = true;
        $keys = RPAxe4Peer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getRPAxe4Id(),
            $keys[1] => $this->getRPAxe4Tag(),
            $keys[2] => $this->getRPAxe4Libelle(),
            $keys[3] => $this->getRPAxe4Actif(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setRPAxe4Id($value);
                break;
            case 1:
                $this->setRPAxe4Tag($value);
                break;
            case 2:
                $this->setRPAxe4Libelle($value);
                break;
            case 3:
                $this->setRPAxe4Actif($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setRPAxe4Id($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setRPAxe4Tag($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setRPAxe4Libelle($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setRPAxe4Actif($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RPAxe4Peer::R_P_AXE4_ID)) $criteria->add(RPAxe4Peer::R_P_AXE4_ID, $this->r_p_axe4_id);
        if ($this->isColumnModified(RPAxe4Peer::R_P_AXE4_TAG)) $criteria->add(RPAxe4Peer::R_P_AXE4_TAG, $this->r_p_axe4_tag);
        if ($this->isColumnModified(RPAxe4Peer::R_P_AXE4_LIBELLE)) $criteria->add(RPAxe4Peer::R_P_AXE4_LIBELLE, $this->r_p_axe4_libelle);
        if ($this->isColumnModified(RPAxe4Peer::R_P_AXE4_ACTIF)) $criteria->add(RPAxe4Peer::R_P_AXE4_ACTIF, $this->r_p_axe4_actif);
    ...
    {
        $criteria = new Criteria(RPAxe4Peer::DATABASE_NAME);
        $criteria->add(RPAxe4Peer::R_P_AXE4_ID, $this->r_p_axe4_id);
    ...
    /**
     * Generic method to set the primary key (r_p_axe4_id column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of RPAxe4 (or compatible) type.
    ...
    {
        $copyObj->setRPAxe4Tag($this->getRPAxe4Tag());
        $copyObj->setRPAxe4Libelle($this->getRPAxe4Libelle());
        $copyObj->setRPAxe4Actif($this->getRPAxe4Actif());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setRPAxe4Id(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return RPAxe4 Clone of current object.
     * @throws PropelException
     */
     ...
     * If this RPAxe4 is new, it will return
    ...
    public function setRPrestationss(PropelCollection $rPrestationss, PropelPDO $con = null)
    {
        ...
        foreach ($rPrestationssToDelete as $rPrestationsRemoved) {
            $rPrestationsRemoved->setAxe4(null);
        }
     ...
     * Otherwise if this RPAxe4 is new, it will return
     * an empty collection; or if this RPAxe4 has previously
     * been saved, it will retrieve related RPrestationss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in RPAxe4.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        $this->r_p_axe4_id = null;
        $this->r_p_axe4_tag = null;
        $this->r_p_axe4_libelle = null;
        $this->r_p_axe4_actif = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(RPAxe4Peer::DEFAULT_STRING_FORMAT);
    }
    ...
    // utils behavior
            ...
            */
            public function getConnection(){
                return BaseRPAxe4Peer::getConnection();
            }
}

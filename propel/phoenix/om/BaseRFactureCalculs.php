...
/**
 * Base class that represents a row from the 'r_facture_calculs' table.
 *
 *
 *
 * @package    propel.generator.phoenix.om
 */
abstract class BaseRFactureCalculs extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'RFactureCalculsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        RFactureCalculsPeer
     */
    ...
    /**
     * The value for the r_fact_calc_libelle field.
     * @var        string
     */
    protected $r_fact_calc_libelle;
    ...
    /**
     * Get the [r_fact_calc_libelle] column value.
     *
     * @return string
     */
    public function getRFactCalcLibelle()
    {

        return $this->r_fact_calc_libelle;
    }
     ...
     * @return RFactureCalculs The current object (for fluent API support)
     */
    public function setRFactCalcId($v)
    {
                ...
                if ($this->r_fact_calc_id !== $v) {
                    ...
                    $this->modifiedColumns[] = RFactureCalculsPeer::R_FACT_CALC_ID;
                }
    ...
    /**
     * Set the value of [r_fact_calc_libelle] column.
     *
     * @param  string $v new value
     * @return RFactureCalculs The current object (for fluent API support)
     */
    public function setRFactCalcLibelle($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->r_fact_calc_libelle !== $v) {
            $this->r_fact_calc_libelle = $v;
            $this->modifiedColumns[] = RFactureCalculsPeer::R_FACT_CALC_LIBELLE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->r_fact_calc_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->r_fact_calc_libelle = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = RFactureCalculsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating RFactureCalculs object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RFactureCalculsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RFactureCalculsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RFactureCalculsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RFactureCalculsPeer::R_FACT_CALC_ID)) {
            $modifiedColumns[':p' . $index++]  = '`r_fact_calc_id`';
        }
        if ($this->isColumnModified(RFactureCalculsPeer::R_FACT_CALC_LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`r_fact_calc_libelle`';
        }

        $sql = sprintf(
            'INSERT INTO `r_facture_calculs` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`r_fact_calc_id`':
                        ...
                        break;
                    case '`r_fact_calc_libelle`':
                        $stmt->bindValue($identifier, $this->r_fact_calc_libelle, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    */
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RFactureCalculsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RFactureCalculsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getRFactCalcLibelle();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['RFactureCalculs'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RFactureCalculs'][$this->getPrimaryKey()] = true;
        $keys = RFactureCalculsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getRFactCalcId(),
            $keys[1] => $this->getRFactCalcLibelle(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setRFactCalcLibelle($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setRFactCalcId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setRFactCalcLibelle($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RFactureCalculsPeer::R_FACT_CALC_ID)) $criteria->add(RFactureCalculsPeer::R_FACT_CALC_ID, $this->r_fact_calc_id);
        if ($this->isColumnModified(RFactureCalculsPeer::R_FACT_CALC_LIBELLE)) $criteria->add(RFactureCalculsPeer::R_FACT_CALC_LIBELLE, $this->r_fact_calc_libelle);
    ...
    {
        $criteria = new Criteria(RFactureCalculsPeer::DATABASE_NAME);
        $criteria->add(RFactureCalculsPeer::R_FACT_CALC_ID, $this->r_fact_calc_id);
    ...
    /**
     * Generic method to set the primary key (r_fact_calc_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getRFactCalcId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of RFactureCalculs (or compatible) type.
    ...
    {
        $copyObj->setRFactCalcLibelle($this->getRFactCalcLibelle());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setRFactCalcId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return RFactureCalculs Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RFactureCalculsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RFactureCalculsPeer();
        }
     ...
     * If this RFactureCalculs is new, it will return
    ...
    public function setRFactureTypess(PropelCollection $rFactureTypess, PropelPDO $con = null)
    {
        ...
        foreach ($rFactureTypessToDelete as $rFactureTypesRemoved) {
            $rFactureTypesRemoved->setRFactureCalculs(null);
        }
    ...
    protected function doAddRFactureTypes($rFactureTypes)
    {
        ...
        $rFactureTypes->setRFactureCalculs($this);
    }
    ...
    public function removeRFactureTypes($rFactureTypes)
    {
        if ($this->getRFactureTypess()->contains($rFactureTypes)) {
            ...
            $rFactureTypes->setRFactureCalculs(null);
        }
     ...
     * Otherwise if this RFactureCalculs is new, it will return
     * an empty collection; or if this RFactureCalculs has previously
     * been saved, it will retrieve related RFactureTypess from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in RFactureCalculs.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|RFactureTypes[] List of RFactureTypes objects
     */
    public function getRFactureTypessJoinRFacturePresentations($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = RFactureTypesQuery::create(null, $criteria);
        $query->joinWith('RFacturePresentations', $join_behavior);
    ...
    {
        return (string) $this->exportTo(RFactureCalculsPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    // utils behavior
            ...
            */
            public function getConnection(){
                return BaseRFactureCalculsPeer::getConnection();
            }
}

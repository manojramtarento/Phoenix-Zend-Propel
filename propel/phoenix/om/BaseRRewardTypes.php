...
/**
 * Base class that represents a row from the 'r_reward_types' table.
 *
 *
 *
 * @package    propel.generator.phoenix.om
 */
abstract class BaseRRewardTypes extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'RRewardTypesPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        RRewardTypesPeer
     */
    ...
    /**
     * The value for the r_reward_type_id field.
     * @var        int
     */
    protected $r_reward_type_id;

    /**
     * The value for the r_reward_type_label field.
     * @var        string
     */
    protected $r_reward_type_label;

    /**
     * The value for the r_reward_type_actif field.
     * Note: this column has a database default value of: 1
     * @var        int
     */
    protected $r_reward_type_actif;
    ...
    {
        $this->r_reward_type_actif = 1;
    }

    /**
     * Initializes internal state of BaseRRewardTypes object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [r_reward_type_id] column value.
     *
     * @return int
     */
    public function getRRewardTypeId()
    {

        return $this->r_reward_type_id;
    }

    /**
     * Get the [r_reward_type_label] column value.
     *
     * @return string
     */
    public function getRRewardTypeLabel()
    {

        return $this->r_reward_type_label;
    }

    /**
     * Get the [r_reward_type_actif] column value.
     *
     * @return int
     */
    public function getRRewardTypeActif()
    {

        return $this->r_reward_type_actif;
    }

    /**
     * Set the value of [r_reward_type_id] column.
     *
     * @param  int $v new value
     * @return RRewardTypes The current object (for fluent API support)
     */
    public function setRRewardTypeId($v)
    {
                if ($v === ''){
                    $v = null;
                }
                ...
                if ($this->r_reward_type_id !== $v) {
                    $this->r_reward_type_id = $v;
                    $this->modifiedColumns[] = RRewardTypesPeer::R_REWARD_TYPE_ID;
                }
    ...
    /**
     * Set the value of [r_reward_type_label] column.
     *
     * @param  string $v new value
     * @return RRewardTypes The current object (for fluent API support)
     */
    public function setRRewardTypeLabel($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->r_reward_type_label !== $v) {
            $this->r_reward_type_label = $v;
            $this->modifiedColumns[] = RRewardTypesPeer::R_REWARD_TYPE_LABEL;
        }
    ...
    /**
     * Set the value of [r_reward_type_actif] column.
     *
     * @param  int $v new value
     * @return RRewardTypes The current object (for fluent API support)
     */
    public function setRRewardTypeActif($v)
    {
                if ($v === ''){
                    $v = null;
                }
                ...
                if ($this->r_reward_type_actif !== $v) {
                    $this->r_reward_type_actif = $v;
                    $this->modifiedColumns[] = RRewardTypesPeer::R_REWARD_TYPE_ACTIF;
                }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->r_reward_type_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->r_reward_type_label = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->r_reward_type_actif = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = RRewardTypesPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating RRewardTypes object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RRewardTypesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RRewardTypesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RRewardTypesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RRewardTypesPeer::R_REWARD_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`r_reward_type_id`';
        }
        if ($this->isColumnModified(RRewardTypesPeer::R_REWARD_TYPE_LABEL)) {
            $modifiedColumns[':p' . $index++]  = '`r_reward_type_label`';
        }
        if ($this->isColumnModified(RRewardTypesPeer::R_REWARD_TYPE_ACTIF)) {
            $modifiedColumns[':p' . $index++]  = '`r_reward_type_actif`';
        }

        $sql = sprintf(
            'INSERT INTO `r_reward_types` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`r_reward_type_id`':
                        $stmt->bindValue($identifier, $this->r_reward_type_id, PDO::PARAM_INT);
                        break;
                    case '`r_reward_type_label`':
                        $stmt->bindValue($identifier, $this->r_reward_type_label, PDO::PARAM_STR);
                        break;
                    case '`r_reward_type_actif`':
                        $stmt->bindValue($identifier, $this->r_reward_type_actif, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    */
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RRewardTypesPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RRewardTypesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getRRewardTypeId();
                break;
            case 1:
                return $this->getRRewardTypeLabel();
                break;
            case 2:
                return $this->getRRewardTypeActif();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['RRewardTypes'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RRewardTypes'][$this->getPrimaryKey()] = true;
        $keys = RRewardTypesPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getRRewardTypeId(),
            $keys[1] => $this->getRRewardTypeLabel(),
            $keys[2] => $this->getRRewardTypeActif(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setRRewardTypeId($value);
                break;
            case 1:
                $this->setRRewardTypeLabel($value);
                break;
            case 2:
                $this->setRRewardTypeActif($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setRRewardTypeId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setRRewardTypeLabel($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setRRewardTypeActif($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RRewardTypesPeer::R_REWARD_TYPE_ID)) $criteria->add(RRewardTypesPeer::R_REWARD_TYPE_ID, $this->r_reward_type_id);
        if ($this->isColumnModified(RRewardTypesPeer::R_REWARD_TYPE_LABEL)) $criteria->add(RRewardTypesPeer::R_REWARD_TYPE_LABEL, $this->r_reward_type_label);
        if ($this->isColumnModified(RRewardTypesPeer::R_REWARD_TYPE_ACTIF)) $criteria->add(RRewardTypesPeer::R_REWARD_TYPE_ACTIF, $this->r_reward_type_actif);
    ...
    {
        $criteria = new Criteria(RRewardTypesPeer::DATABASE_NAME);
        $criteria->add(RRewardTypesPeer::R_REWARD_TYPE_ID, $this->r_reward_type_id);
    ...
    /**
     * Generic method to set the primary key (r_reward_type_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getRRewardTypeId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of RRewardTypes (or compatible) type.
    ...
    {
        $copyObj->setRRewardTypeLabel($this->getRRewardTypeLabel());
        $copyObj->setRRewardTypeActif($this->getRRewardTypeActif());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setRRewardTypeId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return RRewardTypes Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RRewardTypesPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RRewardTypesPeer();
        }
     ...
     * If this RRewardTypes is new, it will return
    ...
    public function setOperationPrimess(PropelCollection $operationPrimess, PropelPDO $con = null)
    {
        ...
        foreach ($operationPrimessToDelete as $operationPrimesRemoved) {
            $operationPrimesRemoved->setRRewardTypes(null);
        }
    ...
    protected function doAddOperationPrimes($operationPrimes)
    {
        ...
        $operationPrimes->setRRewardTypes($this);
    }
    ...
    public function removeOperationPrimes($operationPrimes)
    {
        if ($this->getOperationPrimess()->contains($operationPrimes)) {
            ...
            $operationPrimes->setRRewardTypes(null);
        }
     ...
     * Otherwise if this RRewardTypes is new, it will return
     * an empty collection; or if this RRewardTypes has previously
     * been saved, it will retrieve related OperationPrimess from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in RRewardTypes.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function setROperationTypeSubTplPrimes(PropelCollection $rOperationTypeSubTplPrimes, PropelPDO $con = null)
    {
        ...
        foreach ($rOperationTypeSubTplPrimesToDelete as $rOperationTypeSubTplPrimeRemoved) {
            $rOperationTypeSubTplPrimeRemoved->setRRewardTypes(null);
        }
    ...
    protected function doAddROperationTypeSubTplPrime($rOperationTypeSubTplPrime)
    {
        ...
        $rOperationTypeSubTplPrime->setRRewardTypes($this);
    }
    ...
    public function removeROperationTypeSubTplPrime($rOperationTypeSubTplPrime)
    {
        if ($this->getROperationTypeSubTplPrimes()->contains($rOperationTypeSubTplPrime)) {
            ...
            $rOperationTypeSubTplPrime->setRRewardTypes(null);
        }
     ...
     * @return PropelObjectCollection|ROperationTypeSubTplPrime[] List of ROperationTypeSubTplPrime objects
     */
    public function getROperationTypeSubTplPrimesJoinROperationTypeSubTpl($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ROperationTypeSubTplPrimeQuery::create(null, $criteria);
    ...
    {
        $this->r_reward_type_id = null;
        $this->r_reward_type_label = null;
        $this->r_reward_type_actif = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(RRewardTypesPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    // validateisunique behavior
      ...
      0 => 'r_reward_type_label',
                    ...
                    if(call_user_func(array($oTableMap->getClassName() . 'Peer', 'doCount'), $oCriteria)){
                        if(count($aColumns) === 1){
                            $this->addValidationFailed('Ce type de prime existe déjà.', $aColumns[0]);
                        } else {
                            $this->addValidationFailed('Ce type de prime existe déjà.', 'error');
                        }
                    }
                }
    ...
    // utils behavior
            ...
            */
            public function getConnection(){
                return BaseRRewardTypesPeer::getConnection();
            }
}

...
/**
 * Base class that represents a row from the 'r_currencies' table.
 *
 *
 *
 * @package    propel.generator.phoenix.om
 */
abstract class BaseRCurrencies extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'RCurrenciesPeer';
    ...
    /**
     * The value for the r_currency_id field.
     * @var        int
     */
    protected $r_currency_id;

    /**
     * The value for the r_currency_iso_code field.
     * @var        string
     */
    protected $r_currency_iso_code;

    /**
     * The value for the r_currency_label field.
     * @var        string
     */
    protected $r_currency_label;

    /**
     * The value for the r_currency_actif field.
     * Note: this column has a database default value of: 1
     * @var        int
     */
    protected $r_currency_actif;
    ...
    {
        $this->r_currency_actif = 1;
    }

    /**
     * Initializes internal state of BaseRCurrencies object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [r_currency_id] column value.
     *
     * @return int
     */
    public function getRCurrencyId()
    {

        return $this->r_currency_id;
    }

    /**
     * Get the [r_currency_iso_code] column value.
     *
     * @return string
     */
    public function getRCurrencyIsoCode()
    {

        return $this->r_currency_iso_code;
    }

    /**
     * Get the [r_currency_label] column value.
     *
     * @return string
     */
    public function getRCurrencyLabel()
    {

        return $this->r_currency_label;
    }

    /**
     * Get the [r_currency_actif] column value.
     *
     * @return int
     */
    public function getRCurrencyActif()
    {

        return $this->r_currency_actif;
    }

    /**
     * Set the value of [r_currency_id] column.
     *
     * @param  int $v new value
     * @return RCurrencies The current object (for fluent API support)
     */
    public function setRCurrencyId($v)
    {
                if ($v === ''){
                    $v = null;
                }
                ...
                if ($this->r_currency_id !== $v) {
                    $this->r_currency_id = $v;
                    $this->modifiedColumns[] = RCurrenciesPeer::R_CURRENCY_ID;
                }
    ...
    /**
     * Set the value of [r_currency_iso_code] column.
     *
     * @param  string $v new value
     * @return RCurrencies The current object (for fluent API support)
     */
    public function setRCurrencyIsoCode($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->r_currency_iso_code !== $v) {
            $this->r_currency_iso_code = $v;
            $this->modifiedColumns[] = RCurrenciesPeer::R_CURRENCY_ISO_CODE;
        }
    ...
    /**
     * Set the value of [r_currency_label] column.
     *
     * @param  string $v new value
     * @return RCurrencies The current object (for fluent API support)
     */
    public function setRCurrencyLabel($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->r_currency_label !== $v) {
            $this->r_currency_label = $v;
            $this->modifiedColumns[] = RCurrenciesPeer::R_CURRENCY_LABEL;
        }
    ...
    /**
     * Set the value of [r_currency_actif] column.
     *
     * @param  int $v new value
     * @return RCurrencies The current object (for fluent API support)
     */
    public function setRCurrencyActif($v)
    {
                if ($v === ''){
                    $v = null;
                }
                ...
                if ($this->r_currency_actif !== $v) {
                    $this->r_currency_actif = $v;
                    $this->modifiedColumns[] = RCurrenciesPeer::R_CURRENCY_ACTIF;
                }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->r_currency_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->r_currency_iso_code = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->r_currency_label = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->r_currency_actif = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = RCurrenciesPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating RCurrencies object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RCurrenciesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RCurrenciesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RCurrenciesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = RCurrenciesPeer::R_CURRENCY_ID;
        if (null !== $this->r_currency_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . RCurrenciesPeer::R_CURRENCY_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(RCurrenciesPeer::R_CURRENCY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`r_currency_id`';
        }
        if ($this->isColumnModified(RCurrenciesPeer::R_CURRENCY_ISO_CODE)) {
            $modifiedColumns[':p' . $index++]  = '`r_currency_iso_code`';
        }
        if ($this->isColumnModified(RCurrenciesPeer::R_CURRENCY_LABEL)) {
            $modifiedColumns[':p' . $index++]  = '`r_currency_label`';
        }
        if ($this->isColumnModified(RCurrenciesPeer::R_CURRENCY_ACTIF)) {
            $modifiedColumns[':p' . $index++]  = '`r_currency_actif`';
        }

        $sql = sprintf(
            'INSERT INTO `r_currencies` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`r_currency_id`':
                        $stmt->bindValue($identifier, $this->r_currency_id, PDO::PARAM_INT);
                        break;
                    case '`r_currency_iso_code`':
                        $stmt->bindValue($identifier, $this->r_currency_iso_code, PDO::PARAM_STR);
                        break;
                    case '`r_currency_label`':
                        $stmt->bindValue($identifier, $this->r_currency_label, PDO::PARAM_STR);
                        break;
                    case '`r_currency_actif`':
                        $stmt->bindValue($identifier, $this->r_currency_actif, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    */
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RCurrenciesPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RCurrenciesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getRCurrencyId();
                break;
            case 1:
                return $this->getRCurrencyIsoCode();
                break;
            case 2:
                return $this->getRCurrencyLabel();
                break;
            case 3:
                return $this->getRCurrencyActif();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['RCurrencies'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RCurrencies'][$this->getPrimaryKey()] = true;
        $keys = RCurrenciesPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getRCurrencyId(),
            $keys[1] => $this->getRCurrencyIsoCode(),
            $keys[2] => $this->getRCurrencyLabel(),
            $keys[3] => $this->getRCurrencyActif(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setRCurrencyId($value);
                break;
            case 1:
                $this->setRCurrencyIsoCode($value);
                break;
            case 2:
                $this->setRCurrencyLabel($value);
                break;
            case 3:
                $this->setRCurrencyActif($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setRCurrencyId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setRCurrencyIsoCode($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setRCurrencyLabel($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setRCurrencyActif($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RCurrenciesPeer::R_CURRENCY_ID)) $criteria->add(RCurrenciesPeer::R_CURRENCY_ID, $this->r_currency_id);
        if ($this->isColumnModified(RCurrenciesPeer::R_CURRENCY_ISO_CODE)) $criteria->add(RCurrenciesPeer::R_CURRENCY_ISO_CODE, $this->r_currency_iso_code);
        if ($this->isColumnModified(RCurrenciesPeer::R_CURRENCY_LABEL)) $criteria->add(RCurrenciesPeer::R_CURRENCY_LABEL, $this->r_currency_label);
        if ($this->isColumnModified(RCurrenciesPeer::R_CURRENCY_ACTIF)) $criteria->add(RCurrenciesPeer::R_CURRENCY_ACTIF, $this->r_currency_actif);
    ...
    {
        $criteria = new Criteria(RCurrenciesPeer::DATABASE_NAME);
        $criteria->add(RCurrenciesPeer::R_CURRENCY_ID, $this->r_currency_id);
    ...
    /**
     * Generic method to set the primary key (r_currency_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getRCurrencyId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of RCurrencies (or compatible) type.
    ...
    {
        $copyObj->setRCurrencyIsoCode($this->getRCurrencyIsoCode());
        $copyObj->setRCurrencyLabel($this->getRCurrencyLabel());
        $copyObj->setRCurrencyActif($this->getRCurrencyActif());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setRCurrencyId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return RCurrencies Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RCurrenciesPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RCurrenciesPeer();
        }
     ...
     * If this RCurrencies is new, it will return
    ...
    public function setOperationPrimess(PropelCollection $operationPrimess, PropelPDO $con = null)
    {
        ...
        foreach ($operationPrimessToDelete as $operationPrimesRemoved) {
            $operationPrimesRemoved->setRCurrencies(null);
        }
    ...
    protected function doAddOperationPrimes($operationPrimes)
    {
        ...
        $operationPrimes->setRCurrencies($this);
    }
    ...
    public function removeOperationPrimes($operationPrimes)
    {
        if ($this->getOperationPrimess()->contains($operationPrimes)) {
            ...
            $operationPrimes->setRCurrencies(null);
        }
     ...
     * Otherwise if this RCurrencies is new, it will return
     * an empty collection; or if this RCurrencies has previously
     * been saved, it will retrieve related OperationPrimess from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in RCurrencies.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function setRCountriess(PropelCollection $rCountriess, PropelPDO $con = null)
    {
        ...
        foreach ($rCountriessToDelete as $rCountriesRemoved) {
            $rCountriesRemoved->setRCurrencies(null);
        }
    ...
    protected function doAddRCountries($rCountries)
    {
        ...
        $rCountries->setRCurrencies($this);
    }
    ...
    public function removeRCountries($rCountries)
    {
        if ($this->getRCountriess()->contains($rCountries)) {
            ...
            $rCountries->setRCurrencies(null);
        }
     ...
     * @return PropelObjectCollection|RCountries[] List of RCountries objects
     */
    public function getRCountriessJoinRCountriesCallingCodes($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = RCountriesQuery::create(null, $criteria);
        $query->joinWith('RCountriesCallingCodes', $join_behavior);
    ...
    public function setROperationTypeSubTplCurrenciess(PropelCollection $rOperationTypeSubTplCurrenciess, PropelPDO $con = null)
    {
        ...
        foreach ($rOperationTypeSubTplCurrenciessToDelete as $rOperationTypeSubTplCurrenciesRemoved) {
            $rOperationTypeSubTplCurrenciesRemoved->setRCurrencies(null);
        }
    ...
    protected function doAddROperationTypeSubTplCurrencies($rOperationTypeSubTplCurrencies)
    {
        ...
        $rOperationTypeSubTplCurrencies->setRCurrencies($this);
    }
    ...
    public function removeROperationTypeSubTplCurrencies($rOperationTypeSubTplCurrencies)
    {
        if ($this->getROperationTypeSubTplCurrenciess()->contains($rOperationTypeSubTplCurrencies)) {
            ...
            $rOperationTypeSubTplCurrencies->setRCurrencies(null);
        }
     ...
     * @return PropelObjectCollection|ROperationTypeSubTplCurrencies[] List of ROperationTypeSubTplCurrencies objects
     */
    public function getROperationTypeSubTplCurrenciessJoinROperationTypeSubTpl($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ROperationTypeSubTplCurrenciesQuery::create(null, $criteria);
    ...
    {
        $this->r_currency_id = null;
        $this->r_currency_iso_code = null;
        $this->r_currency_label = null;
        $this->r_currency_actif = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(RCurrenciesPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    // validateisunique behavior
      ...
      0 => 'r_currency_iso_code',
                    ...
                    if(call_user_func(array($oTableMap->getClassName() . 'Peer', 'doCount'), $oCriteria)){
                        if(count($aColumns) === 1){
                            $this->addValidationFailed('Ce code de devise existe déjà.', $aColumns[0]);
                        } else {
                            $this->addValidationFailed('Ce code de devise existe déjà.', 'error');
                        }
                    }
                }
    ...
    // utils behavior
            ...
            */
            public function getConnection(){
                return BaseRCurrenciesPeer::getConnection();
            }
}

...
/**
 * Base class that represents a row from the 'r_p_axe5' table.
 *
 *
 *
 * @package    propel.generator.phoenix.om
 */
abstract class BaseRPAxe5 extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'RPAxe5Peer';
    ...
    /**
     * The value for the r_p_axe5_id field.
     * @var        int
     */
    protected $r_p_axe5_id;

    /**
     * The value for the r_p_axe5_tag field.
     * @var        string
     */
    protected $r_p_axe5_tag;

    /**
     * The value for the r_p_axe5_libelle field.
     * @var        string
     */
    protected $r_p_axe5_libelle;

    /**
     * The value for the r_p_axe5_actif field.
     * @var        boolean
     */
    protected $r_p_axe5_actif;
    ...
    /**
     * Get the [r_p_axe5_id] column value.
     *
     * @return int
     */
    public function getRPAxe5Id()
    {

        return $this->r_p_axe5_id;
    }

    /**
     * Get the [r_p_axe5_tag] column value.
     *
     * @return string
     */
    public function getRPAxe5Tag()
    {

        return $this->r_p_axe5_tag;
    }

    /**
     * Get the [r_p_axe5_libelle] column value.
     *
     * @return string
     */
    public function getRPAxe5Libelle()
    {

        return $this->r_p_axe5_libelle;
    }

    /**
     * Get the [r_p_axe5_actif] column value.
     *
     * @return boolean
     */
    public function getRPAxe5Actif()
    {

        return $this->r_p_axe5_actif;
    }

    /**
     * Set the value of [r_p_axe5_id] column.
     *
     * @param  int $v new value
     * @return RPAxe5 The current object (for fluent API support)
     */
    public function setRPAxe5Id($v)
    {
                if ($v === ''){
                    $v = null;
                }
                ...
                if ($this->r_p_axe5_id !== $v) {
                    $this->r_p_axe5_id = $v;
                    $this->modifiedColumns[] = RPAxe5Peer::R_P_AXE5_ID;
                }
    ...
    /**
     * Set the value of [r_p_axe5_tag] column.
     *
     * @param  string $v new value
     * @return RPAxe5 The current object (for fluent API support)
     */
    public function setRPAxe5Tag($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->r_p_axe5_tag !== $v) {
            $this->r_p_axe5_tag = $v;
            $this->modifiedColumns[] = RPAxe5Peer::R_P_AXE5_TAG;
        }
    ...
    /**
     * Set the value of [r_p_axe5_libelle] column.
     *
     * @param  string $v new value
     * @return RPAxe5 The current object (for fluent API support)
     */
    public function setRPAxe5Libelle($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->r_p_axe5_libelle !== $v) {
            $this->r_p_axe5_libelle = $v;
            $this->modifiedColumns[] = RPAxe5Peer::R_P_AXE5_LIBELLE;
        }
    ...
    /**
     * Sets the value of the [r_p_axe5_actif] column.
     ...
     * @return RPAxe5 The current object (for fluent API support)
     */
    public function setRPAxe5Actif($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
        ...
        if ($this->r_p_axe5_actif !== $v) {
            $this->r_p_axe5_actif = $v;
            $this->modifiedColumns[] = RPAxe5Peer::R_P_AXE5_ACTIF;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->r_p_axe5_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->r_p_axe5_tag = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->r_p_axe5_libelle = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->r_p_axe5_actif = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = RPAxe5Peer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating RPAxe5 object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RPAxe5Peer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RPAxe5Query::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RPAxe5Peer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RPAxe5Peer::R_P_AXE5_ID)) {
            $modifiedColumns[':p' . $index++]  = '`r_p_axe5_id`';
        }
        if ($this->isColumnModified(RPAxe5Peer::R_P_AXE5_TAG)) {
            $modifiedColumns[':p' . $index++]  = '`r_p_axe5_tag`';
        }
        if ($this->isColumnModified(RPAxe5Peer::R_P_AXE5_LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`r_p_axe5_libelle`';
        }
        if ($this->isColumnModified(RPAxe5Peer::R_P_AXE5_ACTIF)) {
            $modifiedColumns[':p' . $index++]  = '`r_p_axe5_actif`';
        }

        $sql = sprintf(
            'INSERT INTO `r_p_axe5` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`r_p_axe5_id`':
                        $stmt->bindValue($identifier, $this->r_p_axe5_id, PDO::PARAM_INT);
                        break;
                    case '`r_p_axe5_tag`':
                        $stmt->bindValue($identifier, $this->r_p_axe5_tag, PDO::PARAM_STR);
                        break;
                    case '`r_p_axe5_libelle`':
                        $stmt->bindValue($identifier, $this->r_p_axe5_libelle, PDO::PARAM_STR);
                        break;
                    case '`r_p_axe5_actif`':
                        $stmt->bindValue($identifier, (int) $this->r_p_axe5_actif, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    */
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RPAxe5Peer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RPAxe5Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getRPAxe5Id();
                break;
            case 1:
                return $this->getRPAxe5Tag();
                break;
            case 2:
                return $this->getRPAxe5Libelle();
                break;
            case 3:
                return $this->getRPAxe5Actif();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['RPAxe5'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RPAxe5'][$this->getPrimaryKey()] = true;
        $keys = RPAxe5Peer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getRPAxe5Id(),
            $keys[1] => $this->getRPAxe5Tag(),
            $keys[2] => $this->getRPAxe5Libelle(),
            $keys[3] => $this->getRPAxe5Actif(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setRPAxe5Id($value);
                break;
            case 1:
                $this->setRPAxe5Tag($value);
                break;
            case 2:
                $this->setRPAxe5Libelle($value);
                break;
            case 3:
                $this->setRPAxe5Actif($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setRPAxe5Id($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setRPAxe5Tag($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setRPAxe5Libelle($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setRPAxe5Actif($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RPAxe5Peer::R_P_AXE5_ID)) $criteria->add(RPAxe5Peer::R_P_AXE5_ID, $this->r_p_axe5_id);
        if ($this->isColumnModified(RPAxe5Peer::R_P_AXE5_TAG)) $criteria->add(RPAxe5Peer::R_P_AXE5_TAG, $this->r_p_axe5_tag);
        if ($this->isColumnModified(RPAxe5Peer::R_P_AXE5_LIBELLE)) $criteria->add(RPAxe5Peer::R_P_AXE5_LIBELLE, $this->r_p_axe5_libelle);
        if ($this->isColumnModified(RPAxe5Peer::R_P_AXE5_ACTIF)) $criteria->add(RPAxe5Peer::R_P_AXE5_ACTIF, $this->r_p_axe5_actif);
    ...
    {
        $criteria = new Criteria(RPAxe5Peer::DATABASE_NAME);
        $criteria->add(RPAxe5Peer::R_P_AXE5_ID, $this->r_p_axe5_id);
    ...
    /**
     * Generic method to set the primary key (r_p_axe5_id column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of RPAxe5 (or compatible) type.
    ...
    {
        $copyObj->setRPAxe5Tag($this->getRPAxe5Tag());
        $copyObj->setRPAxe5Libelle($this->getRPAxe5Libelle());
        $copyObj->setRPAxe5Actif($this->getRPAxe5Actif());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setRPAxe5Id(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return RPAxe5 Clone of current object.
     * @throws PropelException
     */
     ...
     * If this RPAxe5 is new, it will return
    ...
    public function setRPrestationss(PropelCollection $rPrestationss, PropelPDO $con = null)
    {
        ...
        foreach ($rPrestationssToDelete as $rPrestationsRemoved) {
            $rPrestationsRemoved->setAxe5(null);
        }
     ...
     * Otherwise if this RPAxe5 is new, it will return
     * an empty collection; or if this RPAxe5 has previously
     * been saved, it will retrieve related RPrestationss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in RPAxe5.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        $this->r_p_axe5_id = null;
        $this->r_p_axe5_tag = null;
        $this->r_p_axe5_libelle = null;
        $this->r_p_axe5_actif = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(RPAxe5Peer::DEFAULT_STRING_FORMAT);
    }
    ...
    // utils behavior
            ...
            */
            public function getConnection(){
                return BaseRPAxe5Peer::getConnection();
            }
}

...
/**
 * Base class that represents a row from the 'r_relance_statuts' table.
 *
 *
 *
 * @package    propel.generator.phoenix.om
 */
abstract class BaseRRelanceStatuts extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'RRelanceStatutsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        RRelanceStatutsPeer
     */
    ...
    /**
     * The value for the r_rel_statut_id field.
     * @var        int
     */
    protected $r_rel_statut_id;

    /**
     * The value for the r_rel_statut_libelle field.
     * @var        string
     */
    protected $r_rel_statut_libelle;
    ...
    /**
     * Get the [r_rel_statut_id] column value.
     *
     * @return int
     */
    public function getRRelStatutId()
    {

        return $this->r_rel_statut_id;
    }

    /**
     * Get the [r_rel_statut_libelle] column value.
     *
     * @return string
     */
    public function getRRelStatutLibelle()
    {

        return $this->r_rel_statut_libelle;
    }

    /**
     * Set the value of [r_rel_statut_id] column.
     *
     * @param  int $v new value
     * @return RRelanceStatuts The current object (for fluent API support)
     */
    public function setRRelStatutId($v)
    {
                if ($v === ''){
                    $v = null;
                }
                ...
                if ($this->r_rel_statut_id !== $v) {
                    $this->r_rel_statut_id = $v;
                    $this->modifiedColumns[] = RRelanceStatutsPeer::R_REL_STATUT_ID;
                }
    ...
    /**
     * Set the value of [r_rel_statut_libelle] column.
     *
     * @param  string $v new value
     * @return RRelanceStatuts The current object (for fluent API support)
     */
    public function setRRelStatutLibelle($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->r_rel_statut_libelle !== $v) {
            $this->r_rel_statut_libelle = $v;
            $this->modifiedColumns[] = RRelanceStatutsPeer::R_REL_STATUT_LIBELLE;
        }


        return $this;
    } // setRRelStatutLibelle()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->r_rel_statut_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->r_rel_statut_libelle = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = RRelanceStatutsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating RRelanceStatuts object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RRelanceStatutsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RRelanceStatutsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RRelanceStatutsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RRelanceStatutsPeer::R_REL_STATUT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`r_rel_statut_id`';
        }
        if ($this->isColumnModified(RRelanceStatutsPeer::R_REL_STATUT_LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`r_rel_statut_libelle`';
        }

        $sql = sprintf(
            'INSERT INTO `r_relance_statuts` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`r_rel_statut_id`':
                        $stmt->bindValue($identifier, $this->r_rel_statut_id, PDO::PARAM_INT);
                        break;
                    case '`r_rel_statut_libelle`':
                        $stmt->bindValue($identifier, $this->r_rel_statut_libelle, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    */
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RRelanceStatutsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RRelanceStatutsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getRRelStatutId();
                break;
            case 1:
                return $this->getRRelStatutLibelle();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['RRelanceStatuts'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RRelanceStatuts'][$this->getPrimaryKey()] = true;
        $keys = RRelanceStatutsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getRRelStatutId(),
            $keys[1] => $this->getRRelStatutLibelle(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setRRelStatutId($value);
                break;
            case 1:
                $this->setRRelStatutLibelle($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setRRelStatutId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setRRelStatutLibelle($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RRelanceStatutsPeer::R_REL_STATUT_ID)) $criteria->add(RRelanceStatutsPeer::R_REL_STATUT_ID, $this->r_rel_statut_id);
        if ($this->isColumnModified(RRelanceStatutsPeer::R_REL_STATUT_LIBELLE)) $criteria->add(RRelanceStatutsPeer::R_REL_STATUT_LIBELLE, $this->r_rel_statut_libelle);
    ...
    {
        $criteria = new Criteria(RRelanceStatutsPeer::DATABASE_NAME);
        $criteria->add(RRelanceStatutsPeer::R_REL_STATUT_ID, $this->r_rel_statut_id);
    ...
    /**
     * Generic method to set the primary key (r_rel_statut_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getRRelStatutId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of RRelanceStatuts (or compatible) type.
    ...
    {
        $copyObj->setRRelStatutLibelle($this->getRRelStatutLibelle());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setRRelStatutId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return RRelanceStatuts Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RRelanceStatutsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RRelanceStatutsPeer();
        }
     ...
     * If this RRelanceStatuts is new, it will return
    ...
    public function setRelanceStatutss(PropelCollection $relanceStatutss, PropelPDO $con = null)
    {
        ...
        foreach ($relanceStatutssToDelete as $relanceStatutsRemoved) {
            $relanceStatutsRemoved->setRRelanceStatuts(null);
        }
    ...
    protected function doAddRelanceStatuts($relanceStatuts)
    {
        ...
        $relanceStatuts->setRRelanceStatuts($this);
    }
    ...
    public function removeRelanceStatuts($relanceStatuts)
    {
        if ($this->getRelanceStatutss()->contains($relanceStatuts)) {
            ...
            $relanceStatuts->setRRelanceStatuts(null);
        }
     ...
     * Otherwise if this RRelanceStatuts is new, it will return
     * an empty collection; or if this RRelanceStatuts has previously
     * been saved, it will retrieve related RelanceStatutss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in RRelanceStatuts.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|RelanceStatuts[] List of RelanceStatuts objects
     */
    public function getRelanceStatutssJoinRelances($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = RelanceStatutsQuery::create(null, $criteria);
    ...
    public function setRelancess(PropelCollection $relancess, PropelPDO $con = null)
    {
        ...
        foreach ($relancessToDelete as $relancesRemoved) {
            $relancesRemoved->setRRelanceStatuts(null);
        }
    ...
    protected function doAddRelances($relances)
    {
        ...
        $relances->setRRelanceStatuts($this);
    }
    ...
    public function removeRelances($relances)
    {
        if ($this->getRelancess()->contains($relances)) {
            ...
            $relances->setRRelanceStatuts(null);
        }
    ...
    {
        $this->r_rel_statut_id = null;
        $this->r_rel_statut_libelle = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(RRelanceStatutsPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    // utils behavior
            ...
            */
            public function getConnection(){
                return BaseRRelanceStatutsPeer::getConnection();
            }
}

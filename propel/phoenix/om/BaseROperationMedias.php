...
/**
 * Base class that represents a row from the 'r_operation_medias' table.
 *
 *
 *
 * @package    propel.generator.phoenix.om
 */
abstract class BaseROperationMedias extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ROperationMediasPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ROperationMediasPeer
     */
    ...
    /**
     * The value for the r_operation_media_id field.
     * @var        int
     */
    protected $r_operation_media_id;

    /**
     * The value for the r_operation_media_label field.
     * @var        string
     */
    protected $r_operation_media_label;

    /**
     * The value for the r_operation_media_actif field.
     * Note: this column has a database default value of: 1
     * @var        int
     */
    protected $r_operation_media_actif;

    /**
     * The value for the r_operation_media_order field.
     * @var        int
     */
    protected $r_operation_media_order;
    ...
    {
        $this->r_operation_media_actif = 1;
    }

    /**
     * Initializes internal state of BaseROperationMedias object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [r_operation_media_id] column value.
     *
     * @return int
     */
    public function getROperationMediaId()
    {

        return $this->r_operation_media_id;
    }

    /**
     * Get the [r_operation_media_label] column value.
     *
     * @return string
     */
    public function getROperationMediaLabel()
    {

        return $this->r_operation_media_label;
    }

    /**
     * Get the [r_operation_media_actif] column value.
     *
     * @return int
     */
    public function getROperationMediaActif()
    {

        return $this->r_operation_media_actif;
    }

    /**
     * Get the [r_operation_media_order] column value.
     *
     * @return int
     */
    public function getROperationMediaOrder()
    {

        return $this->r_operation_media_order;
    }

    /**
     * Set the value of [r_operation_media_id] column.
     *
     * @param  int $v new value
     * @return ROperationMedias The current object (for fluent API support)
     */
    public function setROperationMediaId($v)
    {
                if ($v === ''){
                    $v = null;
                }
                ...
                if ($this->r_operation_media_id !== $v) {
                    $this->r_operation_media_id = $v;
                    $this->modifiedColumns[] = ROperationMediasPeer::R_OPERATION_MEDIA_ID;
                }


        return $this;
    } // setROperationMediaId()

    /**
     * Set the value of [r_operation_media_label] column.
     *
     * @param  string $v new value
     * @return ROperationMedias The current object (for fluent API support)
     */
    public function setROperationMediaLabel($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->r_operation_media_label !== $v) {
            $this->r_operation_media_label = $v;
            $this->modifiedColumns[] = ROperationMediasPeer::R_OPERATION_MEDIA_LABEL;
        }


        return $this;
    } // setROperationMediaLabel()

    /**
     * Set the value of [r_operation_media_actif] column.
     *
     * @param  int $v new value
     * @return ROperationMedias The current object (for fluent API support)
     */
    public function setROperationMediaActif($v)
    {
                if ($v === ''){
                    $v = null;
                }
                ...
                if ($this->r_operation_media_actif !== $v) {
                    $this->r_operation_media_actif = $v;
                    $this->modifiedColumns[] = ROperationMediasPeer::R_OPERATION_MEDIA_ACTIF;
                }


        return $this;
    } // setROperationMediaActif()

    /**
     * Set the value of [r_operation_media_order] column.
     *
     * @param  int $v new value
     * @return ROperationMedias The current object (for fluent API support)
     */
    public function setROperationMediaOrder($v)
    {
                if ($v === ''){
                    $v = null;
                }
                ...
                if ($this->r_operation_media_order !== $v) {
                    $this->r_operation_media_order = $v;
                    $this->modifiedColumns[] = ROperationMediasPeer::R_OPERATION_MEDIA_ORDER;
                }


        return $this;
    } // setROperationMediaOrder()
    ...
    {
            if ($this->r_operation_media_actif !== 1) {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->r_operation_media_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->r_operation_media_label = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->r_operation_media_actif = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->r_operation_media_order = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = ROperationMediasPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ROperationMedias object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ROperationMediasPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ROperationMediasQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ROperationMediasPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ROperationMediasPeer::R_OPERATION_MEDIA_ID;
        if (null !== $this->r_operation_media_id) {
        ...
        if ($this->isColumnModified(ROperationMediasPeer::R_OPERATION_MEDIA_ID)) {
            $modifiedColumns[':p' . $index++]  = '`r_operation_media_id`';
        }
        if ($this->isColumnModified(ROperationMediasPeer::R_OPERATION_MEDIA_LABEL)) {
            $modifiedColumns[':p' . $index++]  = '`r_operation_media_label`';
        }
        if ($this->isColumnModified(ROperationMediasPeer::R_OPERATION_MEDIA_ACTIF)) {
            $modifiedColumns[':p' . $index++]  = '`r_operation_media_actif`';
        }
        if ($this->isColumnModified(ROperationMediasPeer::R_OPERATION_MEDIA_ORDER)) {
            $modifiedColumns[':p' . $index++]  = '`r_operation_media_order`';
        }

        $sql = sprintf(
            'INSERT INTO `r_operation_medias` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`r_operation_media_id`':
                        $stmt->bindValue($identifier, $this->r_operation_media_id, PDO::PARAM_INT);
                        break;
                    case '`r_operation_media_label`':
                        $stmt->bindValue($identifier, $this->r_operation_media_label, PDO::PARAM_STR);
                        break;
                    case '`r_operation_media_actif`':
                        $stmt->bindValue($identifier, $this->r_operation_media_actif, PDO::PARAM_INT);
                        break;
                    case '`r_operation_media_order`':
                        $stmt->bindValue($identifier, $this->r_operation_media_order, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    */
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ROperationMediasPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ROperationMediasPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getROperationMediaId();
                break;
            case 1:
                return $this->getROperationMediaLabel();
                break;
            case 2:
                return $this->getROperationMediaActif();
                break;
            case 3:
                return $this->getROperationMediaOrder();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['ROperationMedias'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ROperationMedias'][$this->getPrimaryKey()] = true;
        $keys = ROperationMediasPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getROperationMediaId(),
            $keys[1] => $this->getROperationMediaLabel(),
            $keys[2] => $this->getROperationMediaActif(),
            $keys[3] => $this->getROperationMediaOrder(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setROperationMediaId($value);
                break;
            case 1:
                $this->setROperationMediaLabel($value);
                break;
            case 2:
                $this->setROperationMediaActif($value);
                break;
            case 3:
                $this->setROperationMediaOrder($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setROperationMediaId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setROperationMediaLabel($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setROperationMediaActif($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setROperationMediaOrder($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ROperationMediasPeer::R_OPERATION_MEDIA_ID)) $criteria->add(ROperationMediasPeer::R_OPERATION_MEDIA_ID, $this->r_operation_media_id);
        if ($this->isColumnModified(ROperationMediasPeer::R_OPERATION_MEDIA_LABEL)) $criteria->add(ROperationMediasPeer::R_OPERATION_MEDIA_LABEL, $this->r_operation_media_label);
        if ($this->isColumnModified(ROperationMediasPeer::R_OPERATION_MEDIA_ACTIF)) $criteria->add(ROperationMediasPeer::R_OPERATION_MEDIA_ACTIF, $this->r_operation_media_actif);
        if ($this->isColumnModified(ROperationMediasPeer::R_OPERATION_MEDIA_ORDER)) $criteria->add(ROperationMediasPeer::R_OPERATION_MEDIA_ORDER, $this->r_operation_media_order);
    ...
    {
        $criteria = new Criteria(ROperationMediasPeer::DATABASE_NAME);
        $criteria->add(ROperationMediasPeer::R_OPERATION_MEDIA_ID, $this->r_operation_media_id);
    ...
    /**
     * Generic method to set the primary key (r_operation_media_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getROperationMediaId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ROperationMedias (or compatible) type.
    ...
    {
        $copyObj->setROperationMediaLabel($this->getROperationMediaLabel());
        $copyObj->setROperationMediaActif($this->getROperationMediaActif());
        $copyObj->setROperationMediaOrder($this->getROperationMediaOrder());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setROperationMediaId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ROperationMedias Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ROperationMediasPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ROperationMediasPeer();
        }
     ...
     * If this ROperationMedias is new, it will return
    ...
    public function setOperationss(PropelCollection $operationss, PropelPDO $con = null)
    {
        ...
        foreach ($operationssToDelete as $operationsRemoved) {
            $operationsRemoved->setOperationMedia(null);
        }
    ...
    protected function doAddOperations($operations)
    {
        ...
        $operations->setOperationMedia($this);
    }
    ...
    public function removeOperations($operations)
    {
        if ($this->getOperationss()->contains($operations)) {
            ...
            $operations->setOperationMedia(null);
        }
     ...
     * Otherwise if this ROperationMedias is new, it will return
     * an empty collection; or if this ROperationMedias has previously
     * been saved, it will retrieve related Operationss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ROperationMedias.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function setLnkROperationTypeSubTemplateMediasUniversess(PropelCollection $lnkROperationTypeSubTemplateMediasUniversess, PropelPDO $con = null)
    {
        ...
        foreach ($lnkROperationTypeSubTemplateMediasUniversessToDelete as $lnkROperationTypeSubTemplateMediasUniversesRemoved) {
            $lnkROperationTypeSubTemplateMediasUniversesRemoved->setOperationMedia(null);
        }
    ...
    protected function doAddLnkROperationTypeSubTemplateMediasUniverses($lnkROperationTypeSubTemplateMediasUniverses)
    {
        ...
        $lnkROperationTypeSubTemplateMediasUniverses->setOperationMedia($this);
    }
    ...
    public function removeLnkROperationTypeSubTemplateMediasUniverses($lnkROperationTypeSubTemplateMediasUniverses)
    {
        if ($this->getLnkROperationTypeSubTemplateMediasUniversess()->contains($lnkROperationTypeSubTemplateMediasUniverses)) {
            ...
            $lnkROperationTypeSubTemplateMediasUniverses->setOperationMedia(null);
        }
    ...
    {
        $this->r_operation_media_id = null;
        $this->r_operation_media_label = null;
        $this->r_operation_media_actif = null;
        $this->r_operation_media_order = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(ROperationMediasPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    // utils behavior
            ...
            */
            public function getConnection(){
                return BaseROperationMediasPeer::getConnection();
            }
}

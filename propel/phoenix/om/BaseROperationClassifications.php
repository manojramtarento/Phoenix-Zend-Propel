...
/**
 * Base class that represents a row from the 'r_operation_classifications' table.
 *
 *
 *
 * @package    propel.generator.phoenix.om
 */
abstract class BaseROperationClassifications extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ROperationClassificationsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ROperationClassificationsPeer
     */
    ...
    /**
     * The value for the r_operation_classification_id field.
     * @var        int
     */
    protected $r_operation_classification_id;

    /**
     * The value for the r_operation_classification_label field.
     * @var        string
     */
    protected $r_operation_classification_label;
    ...
    /**
     * Get the [r_operation_classification_id] column value.
     *
     * @return int
     */
    public function getROperationClassificationId()
    {

        return $this->r_operation_classification_id;
    }

    /**
     * Get the [r_operation_classification_label] column value.
     *
     * @return string
     */
    public function getROperationClassificationLabel()
    {

        return $this->r_operation_classification_label;
    }

    /**
     * Set the value of [r_operation_classification_id] column.
     *
     * @param  int $v new value
     * @return ROperationClassifications The current object (for fluent API support)
     */
    public function setROperationClassificationId($v)
    {
                if ($v === ''){
                    $v = null;
                }
                ...
                if ($this->r_operation_classification_id !== $v) {
                    $this->r_operation_classification_id = $v;
                    $this->modifiedColumns[] = ROperationClassificationsPeer::R_OPERATION_CLASSIFICATION_ID;
                }


        return $this;
    } // setROperationClassificationId()

    /**
     * Set the value of [r_operation_classification_label] column.
     *
     * @param  string $v new value
     * @return ROperationClassifications The current object (for fluent API support)
     */
    public function setROperationClassificationLabel($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->r_operation_classification_label !== $v) {
            $this->r_operation_classification_label = $v;
            $this->modifiedColumns[] = ROperationClassificationsPeer::R_OPERATION_CLASSIFICATION_LABEL;
        }


        return $this;
    } // setROperationClassificationLabel()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->r_operation_classification_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->r_operation_classification_label = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = ROperationClassificationsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ROperationClassifications object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ROperationClassificationsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ROperationClassificationsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ROperationClassificationsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ROperationClassificationsPeer::R_OPERATION_CLASSIFICATION_ID;
        if (null !== $this->r_operation_classification_id) {
        ...
        if ($this->isColumnModified(ROperationClassificationsPeer::R_OPERATION_CLASSIFICATION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`r_operation_classification_id`';
        }
        if ($this->isColumnModified(ROperationClassificationsPeer::R_OPERATION_CLASSIFICATION_LABEL)) {
            $modifiedColumns[':p' . $index++]  = '`r_operation_classification_label`';
        }

        $sql = sprintf(
            'INSERT INTO `r_operation_classifications` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`r_operation_classification_id`':
                        $stmt->bindValue($identifier, $this->r_operation_classification_id, PDO::PARAM_INT);
                        break;
                    case '`r_operation_classification_label`':
                        $stmt->bindValue($identifier, $this->r_operation_classification_label, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
        ...
        $this->setROperationClassificationId($pk);
    ...
    */
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ROperationClassificationsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ROperationClassificationsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getROperationClassificationId();
                break;
            case 1:
                return $this->getROperationClassificationLabel();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['ROperationClassifications'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ROperationClassifications'][$this->getPrimaryKey()] = true;
        $keys = ROperationClassificationsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getROperationClassificationId(),
            $keys[1] => $this->getROperationClassificationLabel(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setROperationClassificationId($value);
                break;
            case 1:
                $this->setROperationClassificationLabel($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setROperationClassificationId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setROperationClassificationLabel($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ROperationClassificationsPeer::R_OPERATION_CLASSIFICATION_ID)) $criteria->add(ROperationClassificationsPeer::R_OPERATION_CLASSIFICATION_ID, $this->r_operation_classification_id);
        if ($this->isColumnModified(ROperationClassificationsPeer::R_OPERATION_CLASSIFICATION_LABEL)) $criteria->add(ROperationClassificationsPeer::R_OPERATION_CLASSIFICATION_LABEL, $this->r_operation_classification_label);
    ...
    {
        $criteria = new Criteria(ROperationClassificationsPeer::DATABASE_NAME);
        $criteria->add(ROperationClassificationsPeer::R_OPERATION_CLASSIFICATION_ID, $this->r_operation_classification_id);
    ...
    /**
     * Generic method to set the primary key (r_operation_classification_id column).
     *
    ...
    {
        $this->setROperationClassificationId($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getROperationClassificationId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ROperationClassifications (or compatible) type.
    ...
    {
        $copyObj->setROperationClassificationLabel($this->getROperationClassificationLabel());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setROperationClassificationId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ROperationClassifications Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ROperationClassificationsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ROperationClassificationsPeer();
        }
     ...
     * If this ROperationClassifications is new, it will return
        ...
        if (null === $this->collOperationss || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collOperationss) {
                ...
                $collOperationss = OperationsQuery::create(null, $criteria)
                    ->filterByROperationClassifications($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setOperationss(PropelCollection $operationss, PropelPDO $con = null)
    {
        ...
        foreach ($operationssToDelete as $operationsRemoved) {
            $operationsRemoved->setROperationClassifications(null);
        }
    ...
    protected function doAddOperations($operations)
    {
        ...
        $operations->setROperationClassifications($this);
    }
    ...
    public function removeOperations($operations)
    {
        if ($this->getOperationss()->contains($operations)) {
            ...
            $operations->setROperationClassifications(null);
        }
     ...
     * Otherwise if this ROperationClassifications is new, it will return
     * an empty collection; or if this ROperationClassifications has previously
     * been saved, it will retrieve related Operationss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ROperationClassifications.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        $this->r_operation_classification_id = null;
        $this->r_operation_classification_label = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(ROperationClassificationsPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    // utils behavior
            ...
            */
            public function getConnection(){
                return BaseROperationClassificationsPeer::getConnection();
            }
}

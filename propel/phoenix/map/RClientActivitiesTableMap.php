...
class RClientActivitiesTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        // validators
        $this->addValidator('cl_activity_libelle', 'required', 'propel.validator.RequiredValidator', '', 'Le champ cl_activity_libelle doit être renseigné.');
        $this->addValidator('cl_activity_libelle', 'maxLength', 'propel.validator.MaxLengthValidator', '200', 'Le champ cl_activity_libelle ne doit pas dépasser 200 caractères.');
        $this->addValidator('cl_activity_libelle', 'type', 'propel.validator.TypeValidator', 'string', 'Le champ cl_activity_libelle doit être un string.');
        ...
        $this->addValidator('parent_cl_activity_id', 'type', 'propel.validator.TypeValidator', 'int', 'Le champ parent_cl_activity_id doit être un int.');
